...
class BITS(Structure):
    _fields_ = [('A', c_int, 1), ('B', c_int, 2), ('C', c_int, 3), ('D',
        c_int, 4), ('E', c_int, 5), ('F', c_int, 6), ('G', c_int, 7), ('H',
        c_int, 8), ('I', c_int, 9), ('M', c_short, 1), ('N', c_short, 2), (
        'O', c_short, 3), ('P', c_short, 4), ('Q', c_short, 5), ('R',
        c_short, 6), ('S', c_short, 7)]
    ...
    def test_ints(self):
        for i in range(512):
            for name in 'ABCDEFGHI':
                b = BITS()
                setattr(b, name, i)
                self.assertEqual(getattr(b, name), func(byref(b), name.
                    encode('ascii')))
...
class BitFieldTest(unittest.TestCase):
    ...
    def test_longlong(self):
        ...
        class X(Structure):
            _fields_ = [('a', c_longlong, 1), ('b', c_longlong, 62), ('c',
                c_longlong, 1)]
    ...
    def test_ulonglong(self):
        ...
        class X(Structure):
            _fields_ = [('a', c_ulonglong, 1), ('b', c_ulonglong, 62), ('c',
                c_ulonglong, 1)]
        self.assertEqual(sizeof(X), sizeof(c_longlong))
        x = X()
    ...
    def test_signed(self):
        for c_typ in signed_int_types:
            ...
            class X(Structure):
                _fields_ = [('dummy', c_typ), ('a', c_typ, 3), ('b', c_typ,
                    3), ('c', c_typ, 1)]
    ...
    def test_nonint_types(self):
        ...
        self.assertEqual(result, (TypeError,
            'bit fields not allowed for type c_char_p'))
        result = self.fail_fields(('a', c_void_p, 1))
        self.assertEqual(result, (TypeError,
            'bit fields not allowed for type c_void_p'))
        if c_int != c_long:
            result = self.fail_fields(('a', POINTER(c_int), 1))
            self.assertEqual(result, (TypeError,
                'bit fields not allowed for type LP_c_int'))
    ...
    def test_multi_bitfields_size(self):
        ...
        class X(Structure):
            _fields_ = [('a', c_short, 1), ('b', c_short, 14), ('c',
                c_short, 1)]
        self.assertEqual(sizeof(X), sizeof(c_short))


        class X(Structure):
            _fields_ = [('a', c_short, 1), ('a1', c_short), ('b', c_short, 
                14), ('c', c_short, 1)]
        ...
        class X(Structure):
            _fields_ = [('a', c_short, 3), ('b', c_short, 14), ('c',
                c_short, 14)]
        self.assertEqual(sizeof(X), sizeof(c_short) * 3)
    ...
    def test_mixed_4(self):
        ...
        class X(Structure):
            _fields_ = [('a', c_short, 4), ('b', c_short, 4), ('c', c_int, 
                24), ('d', c_short, 4), ('e', c_short, 4), ('f', c_int, 24)]
        if os.name == 'nt':
    ...
    def test_uint32_swap_little_endian(self):
        ...
        class Little(LittleEndianStructure):
            _fields_ = [('a', c_uint32, 24), ('b', c_uint32, 4), ('c',
                c_uint32, 4)]
        b = bytearray(4)
