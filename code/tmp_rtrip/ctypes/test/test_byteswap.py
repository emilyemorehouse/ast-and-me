...
class Test(unittest.TestCase):
    ...
    def test_endian_longlong(self):
        ...
        self.assertEqual(bin(struct.pack('>q', 1311768467294899695)),
            '1234567890ABCDEF')
    ...
    def test_struct_fields_1(self):
        ...
        class T(base):
            pass
        _fields_ = [('a', c_ubyte), ('b', c_byte), ('c', c_short), ('d',
            c_ushort), ('e', c_int), ('f', c_uint), ('g', c_long), ('h',
            c_ulong), ('i', c_longlong), ('k', c_ulonglong), ('l', c_float),
            ('m', c_double), ('n', c_char), ('b1', c_byte, 3), ('b2',
            c_byte, 3), ('b3', c_byte, 2), ('a', c_int * 3 * 3 * 3)]
        T._fields_ = _fields_
    ...
    def test_struct_struct(self):
        for nested, data in ((BigEndianStructure,
            b'\x00\x00\x00\x01\x00\x00\x00\x02'), (LittleEndianStructure,
    ...
    def test_struct_fields_2(self):
        ...
        class S(base):
            _fields_ = [('b', c_byte), ('h', c_short), ('i', c_int), ('d',
                c_double)]
    ...
    def test_unaligned_nonnative_struct_fields(self):
        ...
        class S(base):
            _pack_ = 1
            _fields_ = [('b', c_byte), ('h', c_short), ('_1', c_byte), ('i',
                c_int), ('_2', c_byte), ('d', c_double)]
        s1 = S()
        s1.b = 18
        s1.h = 4660
        s1.i = 305419896
