...
class Test(unittest.TestCase):
    ...
    def test_array2pointer(self):
        ...
        if 2 * sizeof(c_short) == sizeof(c_int):
            ...
            if sys.byteorder == 'little':
                self.assertEqual([ptr[i] for i in range(6)], [42, 0, 17, 0,
                    2, 0])
            else:
                self.assertEqual([ptr[i] for i in range(6)], [0, 42, 0, 17,
                    0, 2])
    ...
    def test_p2a_objects(self):
        ...
        p[1] = b'foo bar'
        self.assertEqual(p._objects, {'1': b'foo bar', '0': b'spam spam',
            id(array): array})
        self.assertIs(array._objects, p._objects)
