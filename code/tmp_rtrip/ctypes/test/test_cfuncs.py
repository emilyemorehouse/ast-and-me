...
class CFunctions(unittest.TestCase):
    ...
    def test_longlong(self):
        ...
        self.assertEqual(self._dll.tf_q(-9223372036854775806), -
            3074457345618258602)
    ...
    def test_longlong_plus(self):
        ...
        self.assertEqual(self._dll.tf_bq(0, -9223372036854775806), -
            3074457345618258602)
        self.assertEqual(self.S(), -9223372036854775806)
    ...
    def test_ulonglong(self):
        ...
        self.assertEqual(self._dll.tf_Q(18446744073709551615), 
            6148914691236517205)
    ...
    def test_ulonglong_plus(self):
        ...
        self.assertEqual(self._dll.tf_bQ(0, 18446744073709551615), 
            6148914691236517205)
        self.assertEqual(self.U(), 18446744073709551615)
