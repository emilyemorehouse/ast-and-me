...
class SlicesTestCase(unittest.TestCase):
    ...
    def test_setslice_cint(self):
        ...
        self.assertRaises(TypeError, setitem, a, slice(0, 5), ['a', 'b',
            'c', 'd', 'e'])
        self.assertRaises(TypeError, setitem, a, slice(0, 5), [1, 2, 3, 4, 
            3.14])
    ...
    def test_char_ptr(self):
        ...
        import operator
        self.assertRaises(ValueError, operator.getitem, res, slice(None,
            None, None))
        self.assertRaises(ValueError, operator.getitem, res, slice(0, None,
            None))
        self.assertRaises(ValueError, operator.getitem, res, slice(None, 5, -1)
            )
        self.assertRaises(ValueError, operator.getitem, res, slice(-5, None,
            None))
        self.assertRaises(TypeError, operator.setitem, res, slice(0, 5),
            'abcde')
        dll.my_free(res)
