...
class StructureTestCase(unittest.TestCase):
    formats = {'c': c_char, 'b': c_byte, 'B': c_ubyte, 'h': c_short, 'H':
        c_ushort, 'i': c_int, 'I': c_uint, 'l': c_long, 'L': c_ulong, 'q':
        c_longlong, 'Q': c_ulonglong, 'f': c_float, 'd': c_double}
    ...
    def test_simple_structs(self):
        for code, tp in self.formats.items():
            ...
            self.assertEqual((sizeof(X), code), (calcsize('c%c0%c' % (code,
                code)), code))
    ...
    def test_fields(self):
        ...
        self.assertRaises((TypeError, AttributeError), setattr, X.x,
            'offset', 92)
    ...
    def test_invalid_field_types(self):
        ...
        class POINT(Structure):
            pass
        self.assertRaises(TypeError, setattr, POINT, '_fields_', [('x', 1),
            ('y', 2)])
    ...
    def test_init_errors(self):
        ...
        self.assertEqual(msg,
            "(Phone) <class 'TypeError'>: expected bytes, int found")
    ...
    def test_subclass_creation(self):
        ...
        self.assertEqual((cls, msg), (AttributeError,
...
class TestRecursiveStructure(unittest.TestCase):
    ...
    def test_contains_itself(self):
        ...
        try:
            ...
            self.assertIn('Structure or union cannot contain itself', str(
                details))
        else:
