...
class DepUtilTestCase(support.TempdirManager, unittest.TestCase):
    ...
    def test_newer_pairwise(self):
        ...
        self.assertEqual(newer_pairwise([one, two], [three, four]), ([one],
            [three]))
    ...
    def test_newer_group(self):
        ...
        self.assertFalse(newer_group([one, two, old_file], three, missing=
            'ignore'))
        self.assertTrue(newer_group([one, two, old_file], three, missing=
            'newer'))
