...
class SDistTestCase(BasePyPIRCCommandTestCase):
    ...
    def get_cmd(self, metadata=None):
        """Returns a cmd"""
        if metadata is None:
            metadata = {'name': 'fake', 'version': '1.0', 'url': 'xxx',
    ...
    def test_add_defaults(self):
        ...
        dist.data_files = [('data', ['data/data.dt', 'buildout.cfg',
            'inroot.txt', 'notexisting']), 'some/file.txt',
            'some/other_file.txt']
    ...
    def test_metadata_check_option(self):
        ...
        cmd.ensure_finalized()
        cmd.run()
        warnings = [msg for msg in self.get_logs(WARN) if msg.startswith(
            'warning: check:')]
    ...
    def test_manual_manifest(self):
        ...
        try:
            ...
            archive.close()
        self.assertEqual(sorted(filenames), ['fake-1.0',
            'fake-1.0/PKG-INFO', 'fake-1.0/README.manual'])
