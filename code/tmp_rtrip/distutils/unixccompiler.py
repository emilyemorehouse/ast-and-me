...
class UnixCCompiler(CCompiler):
    compiler_type = 'unix'
    executables = {'preprocessor': None, 'compiler': ['cc'], 'compiler_so':
        ['cc'], 'compiler_cxx': ['cc'], 'linker_so': ['cc', '-shared'],
        'linker_exe': ['cc'], 'archiver': ['ar', '-cr'], 'ranlib': None}
    ...
    def create_static_lib(self, objects, output_libname, output_dir=None,
        ...
        if self._need_link(objects, output_filename):
            ...
            self.spawn(self.archiver + [output_filename] + objects + self.
                objects)
            if self.ranlib:
                try:
