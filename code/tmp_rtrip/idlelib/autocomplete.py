...
class AutoComplete:
    ...
    def autocomplete_event(self, event):
        ...
        completion)
        """
        if hasattr(event, 'mc_state') and event.mc_state or not self.text.get(
    ...
    def _open_completions_later(self, *args):
        ...
        self._delayed_completion_id = self.text.after(self.popupwait, self.
            _delayed_open_completions, *args)
