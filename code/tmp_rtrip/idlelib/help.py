...
class HelpText(Text):
    ...
    def __init__(self, parent, filename):
        ...
        uhigh = 3 * uhigh // 4
        Text.__init__(self, parent, wrap='word', highlightthickness=0, padx
            =5, borderwidth=0, width=uwide, height=uhigh)
...
def copy_strip():
    ...
    """
    src = join(abspath(dirname(dirname(dirname(__file__)))), 'Doc', 'build',
        'html', 'library', 'idle.html')
