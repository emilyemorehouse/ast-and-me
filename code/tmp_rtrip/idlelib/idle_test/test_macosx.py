...
class IsTypeTkTest(unittest.TestCase):
    ...
    isfuncs = (macosx.isAquaTk, ('carbon', 'cocoa')), (macosx.isCarbonTk,
        'carbon'), (macosx.isCocoaTk, 'cocoa'), (macosx.isXQuartz, 'xquartz')
        ...
        for func, whentrue in self.isfuncs:
            for tktype in alltypes:
                with self.subTest(func=func, whentrue=whentrue, tktype=tktype):
                    ...
                    (self.assertTrue if tktype in whentrue else self.
                        assertFalse)(func())
