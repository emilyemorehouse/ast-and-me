...
class Query(Toplevel):
    ...
    def create_widgets(self):
        ...
        self.error_font = Font(name='TkCaptionFont', exists=True, root=self
            .parent)
        self.entry_error = Label(frame, text=' ', foreground='red', font=
            self.error_font)
        self.button_ok = Button(frame, text='OK', default='active', command
            =self.ok)
        self.button_cancel = Button(frame, text='Cancel', command=self.cancel)
        entrylabel.grid(column=0, row=0, columnspan=3, padx=5, sticky=W)
        self.entry.grid(column=0, row=1, columnspan=3, padx=5, sticky=W + E,
            pady=[10, 0])
        self.entry_error.grid(column=0, row=2, columnspan=3, padx=5, sticky
            =W + E)
...
class ModuleName(Query):
    ...
    def __init__(self, parent, title, message, text0, *, _htest=False,
        _utest=False):
        super().__init__(parent, title, message, text0=text0, _htest=_htest,
            _utest=_utest)
    ...
    def entry_ok(self):
        ...
        try:
            ...
            self.showerror('loader does not support get_filename', parent=self)
            return None
        return file_path
...
class HelpSource(Query):
    ...
    def __init__(self, parent, title, *, menuitem='', filepath='',
        ...
        super().__init__(parent, title, message, text0=menuitem, used_names
            =used_names, _htest=_htest, _utest=_utest)

    def create_widgets(self):
        super().create_widgets()
        frame = self.frame
        pathlabel = Label(frame, anchor='w', justify='left', text=
        ...
        self.path_error = Label(frame, text=' ', foreground='red', font=
            self.error_font)
        ...
        self.path_error.grid(column=0, row=12, columnspan=3, padx=5, sticky
            =W + E)
    ...
    def browse_file(self):
        filetypes = [('HTML Files', '*.htm *.html', 'TEXT'), ('PDF Files',
            '*.pdf', 'TEXT'), ('Windows Help Files', '*.chm'), (
    ...
    def path_ok(self):
        ...
        if not path:
            ...
            if not os.path.exists(path):
                self.showerror('help file path does not exist.', self.
                    path_error)
                return None
            if platform == 'darwin':
                path = 'file://' + path
