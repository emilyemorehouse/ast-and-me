...
_register(MetaPathFinder, machinery.BuiltinImporter, machinery.
    FrozenImporter, machinery.PathFinder, machinery.WindowsRegistryFinder)
...
_register(FileLoader, machinery.SourceFileLoader, machinery.
