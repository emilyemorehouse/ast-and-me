        ...
        if node.type == syms.suite:
            ...
            if expr_node.type == syms.expr_stmt and expr_node.children:
                ...
                if isinstance(left_side, Leaf
                    ) and left_side.value == '__metaclass__':
                    return True
    return False
        ...
        if simple_node.type == syms.simple_stmt and simple_node.children:
            ...
            if expr_node.type == syms.expr_stmt and expr_node.children:
                ...
                if isinstance(left_node, Leaf
                    ) and left_node.value == '__metaclass__':
...
class FixMetaclass(fixer_base.BaseFix):
    ...
    def transform(self, node, results):
        ...
        elif len(suite.children) > 1 and (suite.children[-2].type == token.
            INDENT and suite.children[-1].type == token.DEDENT):
            pass_leaf = Leaf(text_type, 'pass')
