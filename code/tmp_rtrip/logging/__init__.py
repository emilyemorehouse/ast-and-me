...
__all__ = ['BASIC_FORMAT', 'BufferingFormatter', 'CRITICAL', 'DEBUG',
    'ERROR', 'FATAL', 'FileHandler', 'Filter', 'Formatter', 'Handler',
    'INFO', 'LogRecord', 'Logger', 'LoggerAdapter', 'NOTSET', 'NullHandler',
...
DEBUG = 10
NOTSET = 0
_levelToName = {CRITICAL: 'CRITICAL', ERROR: 'ERROR', WARNING: 'WARNING',
    INFO: 'INFO', DEBUG: 'DEBUG', NOTSET: 'NOTSET'}
_nameToLevel = {'CRITICAL': CRITICAL, 'FATAL': FATAL, 'ERROR': ERROR,
...
class LogRecord(object):
    ...
    def __str__(self):
        return '<LogRecord: %s, %s, %s, %s, "%s">' % (self.name, self.
...
_STYLES = {'%': (PercentStyle, BASIC_FORMAT), '{': (StrFormatStyle,
    '{levelname}:{name}:{message}'), '$': (StringTemplateStyle,
...
class Formatter(object):
    ...
    def __init__(self, fmt=None, datefmt=None, style='%'):
        ...
        if style not in _STYLES:
            raise ValueError('Style must be one of: %s' % ','.join(_STYLES.
                keys()))
