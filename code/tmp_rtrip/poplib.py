...
class POP3:
    ...
    def __init__(self, host, port=POP3_PORT, timeout=socket.
        ...
        try:
            ...
            if sock is not None:
                try:
                    ...
                    if exc.errno != errno.ENOTCONN and getattr(exc,
                        'winerror', 0) != 10022:
                        raise
                finally:
                    sock.close()
...
if HAVE_SSL:
    ...
    class POP3_SSL(POP3):
        ...
        def __init__(self, host, port=POP3_SSL_PORT, keyfile=None, certfile
            =None, timeout=socket._GLOBAL_DEFAULT_TIMEOUT, context=None):
