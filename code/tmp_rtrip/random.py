...
__all__ = ['Random', 'seed', 'random', 'uniform', 'randint', 'choice',
    ...
    'expovariate', 'vonmisesvariate', 'gammavariate', 'triangular', 'gauss',
    'betavariate', 'paretovariate', 'weibullvariate', 'getstate',
    'setstate', 'getrandbits', 'choices', 'SystemRandom']
...
class Random(_random.Random):
    ...
    def _randbelow(self, n, int=int, maxsize=1 << BPF, type=type, Method=
        _MethodType, BuiltinMethod=_BuiltinMethodType):
...
To remove the range limitation, add a getrandbits() method."""
    ...
    def choices(self, population, weights=None, *, cum_weights=None, k=1):
        ...
        total = cum_weights[-1]
        return [population[bisect(cum_weights, random() * total)] for i in
            range(k)]
