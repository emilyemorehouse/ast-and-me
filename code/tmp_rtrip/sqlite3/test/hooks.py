...
class CollationTests(unittest.TestCase):
    ...
    def CheckCollationIsUsed(self):
        ...
        self.assertEqual(result, [('c',), ('b',), ('a',)], msg=
...
class ProgressTests(unittest.TestCase):
    ...
    def CheckCancelOperation(self):
        ...
        con.set_progress_handler(progress, 1)
        curs = con.cursor()
        self.assertRaises(sqlite.OperationalError, curs.execute,
            'create table bar (a, b)')
...
class TraceCallbackTests(unittest.TestCase):
    ...
    def CheckTraceCallbackUsed(self):
        ...
        self.assertTrue(any('create table foo' in stmt for stmt in
            traced_statements))
    ...
    def CheckUnicodeContent(self):
        ...
        con.commit()
        self.assertTrue(any(unicode_value in stmt for stmt in
            traced_statements), 
            'Unicode data %s garbled in trace callback: %s' % (ascii(
            unicode_value), ', '.join(map(ascii, traced_statements))))
