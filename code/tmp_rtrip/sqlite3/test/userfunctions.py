...
class AggrCheckType:
    ...
    def step(self, whichType, val):
        theType = {'str': str, 'int': int, 'float': float, 'None': type(
            None), 'blob': bytes}
...
def suite():
    ...
    return unittest.TestSuite((function_suite, aggregate_suite,
        authorizer_suite, unittest.makeSuite(AuthorizerRaiseExceptionTests),
        unittest.makeSuite(AuthorizerIllegalTypeTests), unittest.makeSuite(
