...
_simple_encodings = [AUDIO_FILE_ENCODING_MULAW_8,
    AUDIO_FILE_ENCODING_LINEAR_8, AUDIO_FILE_ENCODING_LINEAR_16,
    AUDIO_FILE_ENCODING_LINEAR_24, AUDIO_FILE_ENCODING_LINEAR_32,
...
class Au_read:
    ...
    def getparams(self):
        return _sunau_params(self.getnchannels(), self.getsampwidth(), self
...
class Au_write:
    ...
    def close(self):
        if self._file:
            try:
                self._ensure_header_written()
                if (self._nframeswritten != self._nframes or self.
                    _datalength != self._datawritten):
                    self._patchheader()
                self._file.flush()
            finally:
                file = self._file
