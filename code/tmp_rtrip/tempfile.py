...
__all__ = ['NamedTemporaryFile', 'TemporaryFile', 'SpooledTemporaryFile',
    ...
    'gettempprefix', 'tempdir', 'gettempdir', 'gettempprefixb', 'gettempdirb']
    ...
    for dir in dirlist:
        ...
        for seq in range(100):
            ...
            try:
                ...
                if _os.name == 'nt' and _os.path.isdir(dir) and _os.access(dir,
                    _os.W_OK):
                    continue
                break
            except OSError:
...
def NamedTemporaryFile(mode='w+b', buffering=-1, encoding=None, newline=
    None, suffix=None, prefix=None, dir=None, delete=True):
    ...
    def TemporaryFile(mode='w+b', buffering=-1, encoding=None, newline=None,
        ...
        if _O_TMPFILE_WORKS:
            try:
                ...
                try:
                    return _io.open(fd, mode, buffering=buffering, newline=
...
class SpooledTemporaryFile:
    ...
    def __init__(self, max_size=0, mode='w+b', buffering=-1, encoding=None,
        ...
        self._TemporaryFileArgs = {'mode': mode, 'buffering': buffering,
            'suffix': suffix, 'prefix': prefix, 'encoding': encoding,
...
class TemporaryDirectory(object):
    ...
    def __init__(self, suffix=None, prefix=None, dir=None):
        ...
        self._finalizer = _weakref.finalize(self, self._cleanup, self.name,
