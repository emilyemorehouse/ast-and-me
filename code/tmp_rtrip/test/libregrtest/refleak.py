...
def dash_R(the_module, test, indirect_test, huntrleaks):
    ...
    for i in range(repcount):
        indirect_test()
        alloc_after, rc_after, fd_after = dash_R_cleanup(fs, ps, pic, zdc, abcs
            )
    ...
    def check_alloc_deltas(deltas):
        ...
        return False
    failed = False
    for deltas, item_name, checker in [(rc_deltas, 'references',
        check_rc_deltas), (alloc_deltas, 'memory blocks',
        check_alloc_deltas), (fd_deltas, 'file descriptors', check_rc_deltas)]:
        if checker(deltas):
