...
class CommonTest(seq_tests.CommonTest):
    ...
    def test_set_subscript(self):
        ...
        self.assertEqual(a, self.type2test([0, 1, 1, 3, 4, 2, 6, 7, 3, 9, 
    ...
    def test_insert(self):
        ...
        b.insert(-200, 'left')
        b.insert(200, 'right')
        self.assertEqual(b, self.type2test(['left', -2, -1, 0, 0, 'foo', 1,
            2, 'right']))
    ...
    def test_index(self):
        ...
        self.assertRaises(ValueError, a.index, 0, 4 * sys.maxsize, -4 * sys
            .maxsize)
    ...
    def test_sort(self):
        ...
        def selfmodifyingComparison(x, y):
            ...
            if x == y:
                ...
                return 1
        self.assertRaises(ValueError, z.sort, key=cmp_to_key(
