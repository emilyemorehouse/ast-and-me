...
class BaseTest:
    ...
    def test_split(self):
        ...
        self.checkequal(['a', 'b', 'c', 'd'], 'a|b|c|d', 'split', '|', sys.
            maxsize - 2)
        self.checkequal(['a|b|c|d'], 'a|b|c|d', 'split', '|', 0)
        self.checkequal(['a', '', 'b||c||d'], 'a||b||c||d', 'split', '|', 2)
        ...
        self.checkequal(['a', '', 'b\x00c\x00d'], 'a\x00\x00b\x00c\x00d',
            'split', '\x00', 2)
        self.checkequal(['a'] * 20, ('a|' * 20)[:-1], 'split', '|')
        self.checkequal(['a'] * 15 + ['a|a|a|a|a'], ('a|' * 20)[:-1],
            'split', '|', 15)
        self.checkequal(['a', 'b', 'c', 'd'], 'a//b//c//d', 'split', '//')
        self.checkequal(['a', 'b//c//d'], 'a//b//c//d', 'split', '//', 1)
        self.checkequal(['a', 'b', 'c//d'], 'a//b//c//d', 'split', '//', 2)
    ...
    def test_rsplit(self):
        ...
        self.checkequal(['a', 'b', 'c', 'd'], 'a|b|c|d', 'rsplit', '|', sys
            .maxsize - 100)
        ...
        self.checkequal(['a\x00\x00b', 'c', 'd'], 'a\x00\x00b\x00c\x00d',
            'rsplit', '\x00', 2)
        self.checkequal(['a'] * 20, ('a|' * 20)[:-1], 'rsplit', '|')
        self.checkequal(['a|a|a|a|a'] + ['a'] * 15, ('a|' * 20)[:-1],
            'rsplit', '|', 15)
        self.checkequal(['a', 'b', 'c', 'd'], 'a//b//c//d', 'rsplit', '//')
        self.checkequal(['a//b//c', 'd'], 'a//b//c//d', 'rsplit', '//', 1)
        self.checkequal(['a//b', 'c', 'd'], 'a//b//c//d', 'rsplit', '//', 2)
    ...
    def test_replace(self):
        ...
        EQ('here and re and re', 'here and there and there', 'replace',
            'the', '', sys.maxsize)
        EQ('here and re and re', 'here and there and there', 'replace',
            'the', '', -1)
        EQ('here and re and re', 'here and there and there', 'replace',
        ...
        EQ('here and re and re', 'here and there and there', 'replace',
            'the', '', 2)
        EQ('here and re and there', 'here and there and there', 'replace',
            'the', '', 1)
        ...
        EQ('WhO gOes there?', 'Who goes there?', 'replace', 'o', 'O')
        EQ('WhO gOes there?', 'Who goes there?', 'replace', 'o', 'O', sys.
            maxsize)
        ...
        EQ('ham, ham, eggs and ham', 'spam, spam, eggs and spam', 'replace',
            'spam', 'ham')
        EQ('ham, ham, eggs and ham', 'spam, spam, eggs and spam', 'replace',
            'spam', 'ham', sys.maxsize)
        EQ('ham, ham, eggs and ham', 'spam, spam, eggs and spam', 'replace',
            'spam', 'ham', -1)
        EQ('ham, ham, eggs and ham', 'spam, spam, eggs and spam', 'replace',
            'spam', 'ham', 4)
    ...
    def test_additional_split(self):
        ...
        self.checkequal(['a', 'b', 'c', 'd'], 'a b c d', 'split', None, sys
            .maxsize - 1)
    ...
    def test_title(self):
        ...
        self.checkequal('Hello ', 'hello ', 'title')
        self.checkequal('Hello ', 'Hello ', 'title')
        self.checkequal('Format This As Title String',
...
class CommonTest(BaseTest):
    ...
    def test_capitalize_nonascii(self):
        self.checkequal('ΩΙῳῳῳ', 'ῳῳῼῼ', 'capitalize')
...
class MixinStrUnicodeUserStringTest:
    ...
    def test_startswith(self):
        ...
        self.checkequal(True, 'helloworld', 'startswith', ('hellowo', 'rld',
            'lowo'), 3)
        self.checkequal(False, 'helloworld', 'startswith', ('hellowo',
            'ello', 'rld'), 3)
    ...
    def test_endswith(self):
        ...
        self.checkequal(True, 'helloworld', 'endswith', ('hellowo', 'rld',
            'lowo'), 3)
        ...
        for start in indices:
            for stop in indices:
                for step in indices[1:]:
                    ...
                    self.checkequal(''.join(L), s, '__getitem__', slice(
                        start, stop, step))
    ...
    def test_join(self):
        ...
        for i in [5, 25, 125]:
            self.checkequal((('a' * i + '-') * i)[:-1], '-', 'join', ['a' *
                i] * i)
            self.checkequal((('a' * i + '-') * i)[:-1], '-', 'join', ('a' *
                i,) * i)
    ...
    def test_formatting(self):
        ...
        for ordinal in (-100, 2097152):
            self.checkraises((ValueError, OverflowError), '%c', '__mod__',
                ordinal)
        ...
        self.checkraises(OverflowError, '%.*f', '__mod__', (sys.maxsize + 1,
            1.0 / 7))
    ...
    def test_formatting_c_limits(self):
        ...
        self.checkraises(OverflowError, '%*s', '__mod__', (PY_SSIZE_T_MAX +
            1, ''))
        self.checkraises(OverflowError, '%.*f', '__mod__', (INT_MAX + 1, 
            1.0 / 7))
        self.checkraises(OverflowError, '%*s', '__mod__', (SIZE_MAX + 1, ''))
        self.checkraises(OverflowError, '%.*f', '__mod__', (UINT_MAX + 1, 
            1.0 / 7))
    ...
    def test_find_etc_raise_correct_error_messages(self):
        s = 'hello'
        x = 'x'
        self.assertRaisesRegex(TypeError, '^find\\(', s.find, x, None, None,
            None)
        self.assertRaisesRegex(TypeError, '^rfind\\(', s.rfind, x, None,
            None, None)
        self.assertRaisesRegex(TypeError, '^index\\(', s.index, x, None,
            None, None)
        self.assertRaisesRegex(TypeError, '^rindex\\(', s.rindex, x, None,
            None, None)
        self.assertRaisesRegex(TypeError, '^count\\(', s.count, x, None,
            None, None)
        self.assertRaisesRegex(TypeError, '^startswith\\(', s.startswith, x,
            None, None, None)
        self.assertRaisesRegex(TypeError, '^endswith\\(', s.endswith, x,
            None, None, None)
