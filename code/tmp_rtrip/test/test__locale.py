...
known_numerics = {'en_US': ('.', ','), 'de_DE': (',', '.'), 'fr_FR': (',',
    ''), 'ps_AF': ('٫', '٬')}
...
class _LocaleTests(unittest.TestCase):
    ...
    def numeric_tester(self, calc_type, calc_value, data_type, used_locale):
        ...
        known_value = known_numerics.get(used_locale, ('', ''))[data_type ==
            'thousands_sep']
        if known_value and calc_value:
            self.assertEqual(calc_value, known_value, self.
                lc_numeric_err_msg % (calc_value, known_value, calc_type,
