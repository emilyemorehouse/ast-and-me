...
class TestOptionalsSingleDash(ParserTestCase):
    ...
    successes = [('', NS(x=None)), ('-x a', NS(x='a')), ('-xa', NS(x='a')),
        ('-x -1', NS(x='-1')), ('-x-1', NS(x='-1'))]


class TestOptionalsSingleDashCombined(ParserTestCase):
    """Test an Optional with a single-dash option string"""
    argument_signatures = [Sig('-x', action='store_true'), Sig('-yyy',
        action='store_const', const=42), Sig('-z')]
    failures = ['a', '--foo', '-xa', '-x --foo', '-x -z', '-z -x', '-yx',
        '-yz a', '-yyyx', '-yyyza', '-xyza']
    successes = [('', NS(x=False, yyy=None, z=None)), ('-x', NS(x=True, yyy
        =None, z=None)), ('-za', NS(x=False, yyy=None, z='a')), ('-z a', NS
        (x=False, yyy=None, z='a')), ('-xza', NS(x=True, yyy=None, z='a')),
        ('-xz a', NS(x=True, yyy=None, z='a')), ('-x -za', NS(x=True, yyy=
        None, z='a')), ('-x -z a', NS(x=True, yyy=None, z='a')), ('-y', NS(
        x=False, yyy=42, z=None)), ('-yyy', NS(x=False, yyy=42, z=None)), (
        '-x -yyy -za', NS(x=True, yyy=42, z='a')), ('-x -yyy -z a', NS(x=
        True, yyy=42, z='a'))]
...
class TestOptionalsSingleDashLong(ParserTestCase):
    ...
    successes = [('', NS(foo=None)), ('-foo a', NS(foo='a')), ('-foo -1',
        NS(foo='-1')), ('-fo a', NS(foo='a')), ('-f a', NS(foo='a'))]
...
class TestOptionalsSingleDashSubsetAmbiguous(ParserTestCase):
    ...
    successes = [('', NS(f=None, foobar=None, foorab=None)), ('-f a', NS(f=
        'a', foobar=None, foorab=None)), ('-fa', NS(f='a', foobar=None,
        foorab=None)), ('-foa', NS(f='oa', foobar=None, foorab=None)), (
        '-fooa', NS(f='ooa', foobar=None, foorab=None)), ('-foobar a', NS(f
        =None, foobar='a', foorab=None)), ('-foorab a', NS(f=None, foobar=
        None, foorab='a'))]
...
class TestOptionalsSingleDashAmbiguous(ParserTestCase):
    ...
    successes = [('', NS(foobar=None, foorab=None)), ('-foob a', NS(foobar=
        'a', foorab=None)), ('-foor a', NS(foobar=None, foorab='a')), (
        '-fooba a', NS(foobar='a', foorab=None)), ('-foora a', NS(foobar=
        None, foorab='a')), ('-foobar a', NS(foobar='a', foorab=None)), (
...
class TestOptionalsNumeric(ParserTestCase):
    ...
    successes = [('', NS(one=None)), ('-1 a', NS(one='a')), ('-1a', NS(one=
        'a')), ('-1-2', NS(one='-2'))]
...
class TestOptionalsDoubleDash(ParserTestCase):
    ...
    successes = [('', NS(foo=None)), ('--foo a', NS(foo='a')), ('--foo=a',
        NS(foo='a')), ('--foo -2.5', NS(foo='-2.5')), ('--foo=-2.5', NS(foo
        ='-2.5'))]
...
class TestOptionalsDoubleDashPartialMatch(ParserTestCase):
    ...
    successes = [('', NS(badger=False, bat=None)), ('--bat X', NS(badger=
        False, bat='X')), ('--bad', NS(badger=True, bat=None)), ('--badg',
        NS(badger=True, bat=None)), ('--badge', NS(badger=True, bat=None)),
...
class TestOptionalsDoubleDashPrefixMatch(ParserTestCase):
    ...
    successes = [('', NS(badger=False, ba=None)), ('--ba X', NS(badger=
        False, ba='X')), ('--ba=X', NS(badger=False, ba='X')), ('--bad', NS
        (badger=True, ba=None)), ('--badg', NS(badger=True, ba=None)), (
        '--badge', NS(badger=True, ba=None)), ('--badger', NS(badger=True,
        ba=None))]


class TestOptionalsSingleDoubleDash(ParserTestCase):
    """Test an Optional with single- and double-dash option strings"""
    argument_signatures = [Sig('-f', action='store_true'), Sig('--bar'),
        Sig('-baz', action='store_const', const=42)]
    failures = ['--bar', '-fbar', '-fbaz', '-bazf', '-b B', 'B']
    successes = [('', NS(f=False, bar=None, baz=None)), ('-f', NS(f=True,
        bar=None, baz=None)), ('--ba B', NS(f=False, bar='B', baz=None)), (
        '-f --bar B', NS(f=True, bar='B', baz=None)), ('-f -b', NS(f=True,
        bar=None, baz=42)), ('-ba -f', NS(f=True, bar=None, baz=42))]
...
class TestOptionalsAlternatePrefixCharsMultipleShortArgs(ParserTestCase):
    ...
    parser_signature = Sig(prefix_chars='+-', add_help=False)
    argument_signatures = [Sig('-x', action='store_true'), Sig('+y', action
        ='store_true'), Sig('+z', action='store_true')]
    failures = ['-w', '-xyz', '+x', '-y', '+xyz']
    successes = [('', NS(x=False, y=False, z=False)), ('-x', NS(x=True, y=
        False, z=False)), ('+y -x', NS(x=True, y=True, z=False)), ('+yz -x',
        NS(x=True, y=True, z=True))]


class TestOptionalsShortLong(ParserTestCase):
    """Test a combination of single- and double-dash option strings"""
    argument_signatures = [Sig('-v', '--verbose', '-n', '--noisy', action=
        'store_true')]
    failures = ['--x --verbose', '-N', 'a', '-v x']
    successes = [('', NS(verbose=False)), ('-v', NS(verbose=True)), (
        '--verbose', NS(verbose=True)), ('-n', NS(verbose=True)), (
...
class TestOptionalsDest(ParserTestCase):
    ...
    failures = ['a']
    successes = [('--foo-bar f', NS(foo_bar='f', zabbaz=None)), ('--baz g',
        NS(foo_bar=None, zabbaz='g')), ('--foo-bar h --baz i', NS(foo_bar=
        'h', zabbaz='i')), ('--baz j --foo-bar k', NS(foo_bar='k', zabbaz='j'))
        ]
...
class TestOptionalsDefault(ParserTestCase):
    ...
    failures = ['a']
    successes = [('', NS(x=None, y=42)), ('-xx', NS(x='x', y=42)), ('-yy',
        NS(x=None, y='y'))]
...
class TestOptionalsNargsOptional(ParserTestCase):
    ...
    argument_signatures = [Sig('-w', nargs='?'), Sig('-x', nargs='?', const
        =42), Sig('-y', nargs='?', default='spam'), Sig('-z', nargs='?',
        type=int, const='42', default='84')]
    failures = ['2']
    successes = [('', NS(w=None, x=None, y='spam', z=84)), ('-w', NS(w=None,
        x=None, y='spam', z=84)), ('-w 2', NS(w='2', x=None, y='spam', z=84
        )), ('-x', NS(w=None, x=42, y='spam', z=84)), ('-x 2', NS(w=None, x
        ='2', y='spam', z=84)), ('-y', NS(w=None, x=None, y=None, z=84)), (
        '-y 2', NS(w=None, x=None, y='2', z=84)), ('-z', NS(w=None, x=None,
        y='spam', z=42)), ('-z 2', NS(w=None, x=None, y='spam', z=2))]
...
class TestOptionalsNargsZeroOrMore(ParserTestCase):
    ...
    argument_signatures = [Sig('-x', nargs='*'), Sig('-y', nargs='*',
        default='spam')]
    failures = ['a']
    successes = [('', NS(x=None, y='spam')), ('-x', NS(x=[], y='spam')), (
        '-x a', NS(x=['a'], y='spam')), ('-x a b', NS(x=['a', 'b'], y=
        'spam')), ('-y', NS(x=None, y=[])), ('-y a', NS(x=None, y=['a'])),
...
class TestOptionalsNargsOneOrMore(ParserTestCase):
    ...
    successes = [('', NS(x=None, y='spam')), ('-x a', NS(x=['a'], y='spam')
        ), ('-x a b', NS(x=['a', 'b'], y='spam')), ('-y a', NS(x=None, y=[
        'a'])), ('-y a b', NS(x=None, y=['a', 'b']))]


class TestOptionalsChoices(ParserTestCase):
    """Tests specifying the choices for an Optional"""
    argument_signatures = [Sig('-f', choices='abc'), Sig('-g', type=int,
        choices=range(5))]
    failures = ['a', '-f d', '-fad', '-ga', '-g 6']
    successes = [('', NS(f=None, g=None)), ('-f a', NS(f='a', g=None)), (
        '-f c', NS(f='c', g=None)), ('-g 0', NS(f=None, g=0)), ('-g 03', NS
        (f=None, g=3)), ('-fb -g4', NS(f='b', g=4))]
...
class TestOptionalsActionAppend(ParserTestCase):
    ...
    successes = [('', NS(baz=None)), ('--baz a', NS(baz=['a'])), (
...
class TestOptionalsActionAppendConstWithDefault(ParserTestCase):
    """Tests the append_const action for an Optional"""
    argument_signatures = [Sig('-b', action='append_const', const=Exception,
        default=['X']), Sig('-c', action='append', dest='b')]
    failures = ['a', '-c', 'a -c', '-bx', '-b x']
    successes = [('', NS(b=['X'])), ('-b', NS(b=['X', Exception])), (
...
class TestOptionalsAllowLongAbbreviation(ParserTestCase):
    ...
    argument_signatures = [Sig('--foo'), Sig('--foobaz'), Sig('--fooble',
        action='store_true')]
    failures = ['--foob 5', '--foob']
    successes = [('', NS(foo=None, foobaz=None, fooble=False)), ('--foo 7',
        NS(foo='7', foobaz=None, fooble=False)), ('--fooba a', NS(foo=None,
        foobaz='a', fooble=False)), ('--foobl --foo g', NS(foo='g', foobaz=
        None, fooble=True))]
...
class TestOptionalsDisallowLongAbbreviation(ParserTestCase):
    ...
    argument_signatures = [Sig('--foo'), Sig('--foodle', action=
        'store_true'), Sig('--foonly')]
    failures = ['-foon 3', '--foon 3', '--food', '--food --foo 2']
    successes = [('', NS(foo=None, foodle=False, foonly=None)), ('--foo 3',
        NS(foo='3', foodle=False, foonly=None)), (
...
class TestPositionalsNargsZeroOrMore(ParserTestCase):
    ...
    failures = ['-x']
    successes = [('', NS(foo=[])), ('a', NS(foo=['a'])), ('a b', NS(foo=[
        'a', 'b']))]
...
class TestPositionalsNargsZeroOrMoreDefault(ParserTestCase):
    ...
    failures = ['-x']
    successes = [('', NS(foo='bar')), ('a', NS(foo=['a'])), ('a b', NS(foo=
        ['a', 'b']))]
...
class TestPositionalsNargsNoneZeroOrMore(ParserTestCase):
    ...
    failures = ['', '--foo']
    successes = [('a', NS(foo='a', bar=[])), ('a b', NS(foo='a', bar=['b'])
...
class TestPositionalsNargsNoneOneOrMore(ParserTestCase):
    ...
    argument_signatures = [Sig('foo'), Sig('bar', nargs='+')]
    failures = ['', '--foo', 'a']
    successes = [('a b', NS(foo='a', bar=['b'])), ('a b c', NS(foo='a', bar
        =['b', 'c']))]
...
class TestPositionalsNargsZeroOrMoreNone(ParserTestCase):
    ...
    failures = ['', '--foo']
    successes = [('a', NS(foo=[], bar='a')), ('a b', NS(foo=['a'], bar='b')
...
class TestPositionalsNargsOneOrMoreNone(ParserTestCase):
    ...
    argument_signatures = [Sig('foo', nargs='+'), Sig('bar')]
    failures = ['', '--foo', 'a']
    successes = [('a b', NS(foo=['a'], bar='b')), ('a b c', NS(foo=['a',
        'b'], bar='c'))]
...
class TestPositionalsNargs2ZeroOrMore(ParserTestCase):
    ...
    failures = ['', '--foo', 'a']
    successes = [('a b', NS(foo=['a', 'b'], bar=[])), ('a b c', NS(foo=['a',
        'b'], bar=['c']))]
...
class TestPositionalsNargs2Optional(ParserTestCase):
    ...
    successes = [('a b', NS(foo=['a', 'b'], bar=None)), ('a b c', NS(foo=[
        'a', 'b'], bar='c'))]
...
class TestPositionalsNargsZeroOrMore1(ParserTestCase):
    ...
    failures = ['', '--foo']
    successes = [('a', NS(foo=[], bar=['a'])), ('a b', NS(foo=['a'], bar=[
        'b'])), ('a b c', NS(foo=['a', 'b'], bar=['c']))]
...
class TestPositionalsNargsOptional1(ParserTestCase):
    ...
    argument_signatures = [Sig('foo', nargs='?'), Sig('bar', nargs=1)]
    failures = ['', '--foo', 'a b c']
    successes = [('a', NS(foo=None, bar=['a'])), ('a b', NS(foo='a', bar=[
        'b']))]


class TestPositionalsNargsNoneZeroOrMore1(ParserTestCase):
    """Test three Positionals: no nargs, unlimited nargs and 1 nargs"""
    argument_signatures = [Sig('foo'), Sig('bar', nargs='*'), Sig('baz',
        nargs=1)]
    failures = ['', '--foo', 'a']
    successes = [('a b', NS(foo='a', bar=[], baz=['b'])), ('a b c', NS(foo=
        'a', bar=['b'], baz=['c']))]
...
class TestPositionalsNargsNoneOneOrMore1(ParserTestCase):
    ...
    argument_signatures = [Sig('foo'), Sig('bar', nargs='+'), Sig('baz',
        nargs=1)]
    failures = ['', '--foo', 'a', 'b']
    successes = [('a b c', NS(foo='a', bar=['b'], baz=['c'])), ('a b c d',
        NS(foo='a', bar=['b', 'c'], baz=['d']))]


class TestPositionalsNargsNoneOptional1(ParserTestCase):
    """Test three Positionals: no nargs, optional narg and 1 nargs"""
    argument_signatures = [Sig('foo'), Sig('bar', nargs='?', default=0.625),
        Sig('baz', nargs=1)]
    failures = ['', '--foo', 'a']
    successes = [('a b', NS(foo='a', bar=0.625, baz=['b'])), ('a b c', NS(
        foo='a', bar='b', baz=['c']))]
...
class TestPositionalsNargsOptionalOptional(ParserTestCase):
    ...
    argument_signatures = [Sig('foo', nargs='?'), Sig('bar', nargs='?',
        default=42)]
    failures = ['--foo', 'a b c']
    successes = [('', NS(foo=None, bar=42)), ('a', NS(foo='a', bar=42)), (
        'a b', NS(foo='a', bar='b'))]
...
class TestPositionalsNargsOptionalZeroOrMore(ParserTestCase):
    ...
    argument_signatures = [Sig('foo', nargs='?'), Sig('bar', nargs='*')]
    failures = ['--foo']
    successes = [('', NS(foo=None, bar=[])), ('a', NS(foo='a', bar=[])), (
        'a b', NS(foo='a', bar=['b'])), ('a b c', NS(foo='a', bar=['b', 'c']))]
...
class TestPositionalsActionAppend(ParserTestCase):
    ...
    argument_signatures = [Sig('spam', action='append'), Sig('spam', action
        ='append', nargs=2)]
    failures = ['', '--foo', 'a', 'a b', 'a b c d']
...
class TestOptionalsNumericAndPositionals(ParserTestCase):
    ...
    argument_signatures = [Sig('x', nargs='?'), Sig('-4', dest='y', action=
        'store_true')]
    failures = ['-2', '-315']
    successes = [('', NS(x=None, y=False)), ('a', NS(x='a', y=False)), (
        '-4', NS(x=None, y=True)), ('-4 a', NS(x='a', y=True))]
...
class TestOptionalsAlmostNumericAndPositionals(ParserTestCase):
    ...
    argument_signatures = [Sig('x', nargs='?'), Sig('-k4', dest='y', action
        ='store_true')]
    failures = ['-k3']
    successes = [('', NS(x=None, y=False)), ('-2', NS(x='-2', y=False)), (
        'a', NS(x='a', y=False)), ('-k4', NS(x=None, y=True)), ('-k4 a', NS
        (x='a', y=True))]
...
class TestEmptyAndSpaceContainingArguments(ParserTestCase):
    ...
    failures = ['-y']
    successes = [([''], NS(x='', y=None)), (['a badger'], NS(x='a badger',
        y=None)), (['-a badger'], NS(x='-a badger', y=None)), (['-y', ''],
        NS(x=None, y='')), (['-y', 'a badger'], NS(x=None, y='a badger')),
        (['-y', '-a badger'], NS(x=None, y='-a badger')), ([
        '--yyy=a badger'], NS(x=None, y='a badger')), (['--yyy=-a badger'],
        NS(x=None, y='-a badger'))]


class TestPrefixCharacterOnlyArguments(ParserTestCase):
    parser_signature = Sig(prefix_chars='-+')
    argument_signatures = [Sig('-', dest='x', nargs='?', const='badger'),
        Sig('+', dest='y', type=int, default=42), Sig('-+-', dest='z',
        action='store_true')]
    failures = ['-y', '+ -']
    successes = [('', NS(x=None, y=42, z=False)), ('-', NS(x='badger', y=42,
        z=False)), ('- X', NS(x='X', y=42, z=False)), ('+ -3', NS(x=None, y
        =-3, z=False)), ('-+-', NS(x=None, y=42, z=True)), ('- ===', NS(x=
        '===', y=42, z=False))]
...
class TestNargsZeroOrMore(ParserTestCase):
    ...
    argument_signatures = [Sig('-x', nargs='*'), Sig('y', nargs='*')]
    failures = []
    successes = [('', NS(x=None, y=[])), ('-x', NS(x=[], y=[])), ('-x a',
        NS(x=['a'], y=[])), ('-x a -- b', NS(x=['a'], y=['b'])), ('a', NS(x
        =None, y=['a'])), ('a -x', NS(x=[], y=['a'])), ('a -x b', NS(x=['b'
        ], y=['a']))]
...
class TestNargsRemainder(ParserTestCase):
    ...
    failures = ['', '-z', '-z Z']
    successes = [('X', NS(x='X', y=[], z=None)), ('-z Z X', NS(x='X', y=[],
        z='Z')), ('X A B -z Z', NS(x='X', y=['A', 'B', '-z', 'Z'], z=None)),
        ('X Y --foo', NS(x='X', y=['Y', '--foo'], z=None))]


class TestOptionLike(ParserTestCase):
    """Tests options that may or may not be arguments"""
    argument_signatures = [Sig('-x', type=float), Sig('-3', type=float,
        dest='y'), Sig('z', nargs='*')]
    failures = ['-x', '-y2.5', '-xa', '-x -a', '-x -3', '-x -3.5',
        '-3 -3.5', '-x -2.5', '-x -2.5 a', '-3 -.5', 'a x -1', '-x -1 a',
        '-3 -1 a']
    successes = [('', NS(x=None, y=None, z=[])), ('-x 2.5', NS(x=2.5, y=
        None, z=[])), ('-x 2.5 a', NS(x=2.5, y=None, z=['a'])), ('-3.5', NS
        (x=None, y=0.5, z=[])), ('-3-.5', NS(x=None, y=-0.5, z=[])), (
        '-3 .5', NS(x=None, y=0.5, z=[])), ('a -3.5', NS(x=None, y=0.5, z=[
        'a'])), ('a', NS(x=None, y=None, z=['a'])), ('a -x 1', NS(x=1.0, y=
        None, z=['a'])), ('-x 1 a', NS(x=1.0, y=None, z=['a'])), ('-3 1 a',
        NS(x=None, y=1.0, z=['a']))]


class TestDefaultSuppress(ParserTestCase):
    """Test actions with suppressed defaults"""
    argument_signatures = [Sig('foo', nargs='?', default=argparse.SUPPRESS),
        Sig('bar', nargs='*', default=argparse.SUPPRESS), Sig('--baz',
        action='store_true', default=argparse.SUPPRESS)]
    failures = ['-x']
    successes = [('', NS()), ('a', NS(foo='a')), ('a b', NS(foo='a', bar=[
        'b'])), ('--baz', NS(baz=True)), ('a --baz', NS(foo='a', baz=True)),
...
class TestParserDefault42(ParserTestCase):
    ...
    argument_signatures = [Sig('--version', action='version', version='1.0'
        ), Sig('foo', nargs='?'), Sig('bar', nargs='*'), Sig('--baz',
        action='store_true')]
    failures = ['-x']
    successes = [('', NS(foo=42, bar=42, baz=42, version=42)), ('a', NS(foo
        ='a', bar=42, baz=42, version=42)), ('a b', NS(foo='a', bar=['b'],
        baz=42, version=42)), ('--baz', NS(foo=42, bar=42, baz=True,
        version=42)), ('a --baz', NS(foo='a', bar=42, baz=True, version=42)
...
class TestArgumentsFromFile(TempDirMixin, ParserTestCase):
    ...
    successes = [('X Y', NS(a=None, x='X', y=['Y'])), ('X -a A Y Z', NS(a=
        'A', x='X', y=['Y', 'Z'])), ('@hello X', NS(a=None, x=
        'hello world!', y=['X'])), ('X @hello', NS(a=None, x='X', y=[
        'hello world!'])), ('-a B @recursive Y Z', NS(a='A', x=
        'hello world!', y=['Y', 'Z'])), ('X @recursive Z -a B', NS(a='B', x
        ='X', y=['hello world!', 'Z'])), (['-a', '', 'X', 'Y'], NS(a='', x=
        'X', y=['Y']))]
...
class TestFileTypeR(TempDirMixin, ParserTestCase):
    ...
    argument_signatures = [Sig('-x', type=argparse.FileType()), Sig('spam',
        type=argparse.FileType('r'))]
    failures = ['-x', '', 'non-existent-file.txt']
    successes = [('foo', NS(x=None, spam=RFile('foo'))), ('-x foo bar', NS(
        x=RFile('foo'), spam=RFile('bar'))), ('bar -x foo', NS(x=RFile(
        'foo'), spam=RFile('bar'))), ('-x - -', NS(x=sys.stdin, spam=sys.
        stdin)), ('readonly', NS(x=None, spam=RFile('readonly')))]
...
class TestFileTypeDefaults(TempDirMixin, ParserTestCase):
    ...
    def setUp(self):
        ...
        file.write('good')
        file.close()
    argument_signatures = [Sig('-c', type=argparse.FileType('r'), default=
        'no-file.txt')]
    failures = ['']
...
class TestFileTypeRB(TempDirMixin, ParserTestCase):
    ...
    def setUp(self):
        ...
        for file_name in ['foo', 'bar']:
            ...
            file.write(file_name)
            file.close()
    argument_signatures = [Sig('-x', type=argparse.FileType('rb')), Sig(
        'spam', type=argparse.FileType('rb'))]
    failures = ['-x', '']
    successes = [('foo', NS(x=None, spam=RFile('foo'))), ('-x foo bar', NS(
        x=RFile('foo'), spam=RFile('bar'))), ('bar -x foo', NS(x=RFile(
        'foo'), spam=RFile('bar'))), ('-x - -', NS(x=sys.stdin, spam=sys.
...
class TestFileTypeW(TempDirMixin, ParserTestCase):
    ...
    def setUp(self):
        ...
        self.create_readonly_file('readonly')
    argument_signatures = [Sig('-x', type=argparse.FileType('w')), Sig(
        'spam', type=argparse.FileType('w'))]
    failures = ['-x', '', 'readonly']
    successes = [('foo', NS(x=None, spam=WFile('foo'))), ('-x foo bar', NS(
        x=WFile('foo'), spam=WFile('bar'))), ('bar -x foo', NS(x=WFile(
        'foo'), spam=WFile('bar'))), ('-x - -', NS(x=sys.stdout, spam=sys.
        stdout))]


class TestFileTypeWB(TempDirMixin, ParserTestCase):
    argument_signatures = [Sig('-x', type=argparse.FileType('wb')), Sig(
        'spam', type=argparse.FileType('wb'))]
    failures = ['-x', '']
    successes = [('foo', NS(x=None, spam=WFile('foo'))), ('-x foo bar', NS(
        x=WFile('foo'), spam=WFile('bar'))), ('bar -x foo', NS(x=WFile(
        'foo'), spam=WFile('bar'))), ('-x - -', NS(x=sys.stdout, spam=sys.
...
class TestFileTypeOpenArgs(TestCase):
    ...
    def test_open_args(self):
        ...
        cases = [(FT('rb'), ('rb', -1, None, None)), (FT('w', 1), ('w', 1,
            None, None)), (FT('w', errors='replace'), ('w', -1, None,
            'replace')), (FT('wb', encoding='big5'), ('wb', -1, 'big5',
            None)), (FT('w', 0, 'l1', 'strict'), ('w', 0, 'l1', 'strict'))]
...
class TestTypeCallable(ParserTestCase):
    ...
    successes = [('--eggs=42 42', NS(eggs=42, spam=42.0)), (
        '--eggs 2j -- -1.5', NS(eggs=2j, spam=-1.5)), ('1024.675', NS(eggs=
        None, spam=1024.675))]
...
class TestTypeUserDefined(ParserTestCase):
    ...
    failures = []
    successes = [('a -x b', NS(x=MyType('b'), spam=MyType('a'))), ('-xf g',
        NS(x=MyType('f'), spam=MyType('g')))]
...
class TestTypeClassicClass(ParserTestCase):
    ...
    failures = []
    successes = [('a -x b', NS(x=C('b'), spam=C('a'))), ('-xf g', NS(x=C(
        'f'), spam=C('g')))]
...
class TestTypeRegistration(TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(parser.parse_args('1'.split()), NS(x=None, y=
            'my_type{1}'))
        self.assertEqual(parser.parse_args('-x 1 42'.split()), NS(x=
            'my_type{1}', y='my_type{42}'))
...
class TestActionUserDefined(ParserTestCase):
    ...
    argument_signatures = [Sig('-s', dest='spam', action=OptionalAction,
        type=float, default=0.25), Sig('badger', action=PositionalAction,
        type=int, nargs='?', default=2)]
    failures = []
    successes = [('-s0.125', NS(spam=0.125, badger=2)), ('42', NS(spam=0.25,
        badger=42)), ('-s 0.625 1', NS(spam=0.625, badger=1)), ('84 -s2',
        NS(spam=2.0, badger=84))]
...
class TestAddSubparsers(TestCase):
    ...
    def _get_parser(self, subparser_help=False, prefix_chars=None, aliases=
        False):
        if prefix_chars:
            parser = ErrorRaisingArgumentParser(prog='PROG', description=
                'main description', prefix_chars=prefix_chars)
            parser.add_argument(prefix_chars[0] * 2 + 'foo', action=
    ...
    def test_parse_args_failures(self):
        for args_str in ['', 'a', 'a a', '0.5 a', '0.5 1', '0.5 1 -y',
            '0.5 2 -w']:
            args = args_str.split()
            self.assertArgumentParserError(self.parser.parse_args, args)

    def test_parse_args(self):
        self.assertEqual(self.parser.parse_args('0.5 1 b -w 7'.split()), NS
            (foo=False, bar=0.5, w=7, x='b'))
        self.assertEqual(self.parser.parse_args(
            '0.25 --foo 2 -y 2 3j -- -1j'.split()), NS(foo=True, bar=0.25,
            y='2', z=[3j, -1j]))
        self.assertEqual(self.parser.parse_args('--foo 0.125 1 c'.split()),
            NS(foo=True, bar=0.125, w=None, x='c'))
        self.assertEqual(self.parser.parse_args(
            '-1.5 3 11 -- a --foo 7 -- b'.split()), NS(foo=False, bar=-1.5,
            t=11, u=['a', '--foo', '7', '--', 'b']))

    def test_parse_known_args(self):
        self.assertEqual(self.parser.parse_known_args('0.5 1 b -w 7'.split(
            )), (NS(foo=False, bar=0.5, w=7, x='b'), []))
        self.assertEqual(self.parser.parse_known_args('0.5 -p 1 b -w 7'.
            split()), (NS(foo=False, bar=0.5, w=7, x='b'), ['-p']))
        self.assertEqual(self.parser.parse_known_args('0.5 1 b -w 7 -p'.
            split()), (NS(foo=False, bar=0.5, w=7, x='b'), ['-p']))
        self.assertEqual(self.parser.parse_known_args('0.5 1 b -q -rs -w 7'
            .split()), (NS(foo=False, bar=0.5, w=7, x='b'), ['-q', '-rs']))
        self.assertEqual(self.parser.parse_known_args(
            '0.5 -W 1 b -X Y -w 7 Z'.split()), (NS(foo=False, bar=0.5, w=7,
            x='b'), ['-W', '-X', 'Y', 'Z']))
    ...
    def test_dest(self):
        ...
        self.assertEqual(NS(foo=False, bar='1', baz='2'), parser.parse_args
            ('1 2'.split()))
    ...
    def test_help_non_breaking_spaces(self):
        parser = ErrorRaisingArgumentParser(prog='PROG', description=
            'main description')
        parser.add_argument('--non-breaking', action='store_false', help=
            'help message containing non-breaking spaces shall not wrap\xa0at non-breaking spaces'
            )
        self.assertEqual(parser.format_help(), textwrap.dedent(
    ...
    def test_parser_command_help(self):
        self.assertEqual(self.command_help_parser.format_usage(),
            """usage: PROG [-h] [--foo] bar {1,2,3} ...
""")
        self.assertEqual(self.command_help_parser.format_help(), textwrap.
            dedent(
            """            usage: PROG [-h] [--foo] bar {1,2,3} ...
    ...
    def test_subparser_title_help(self):
        ...
        subparsers = parser.add_subparsers(title='subcommands', description
            ='command help', help='additional text')
        parser1 = subparsers.add_parser('1')
    ...
    def test_alias_invocation(self):
        ...
        self.assertEqual(parser.parse_known_args('0.5 1alias1 b'.split()),
            (NS(foo=False, bar=0.5, w=None, x='b'), []))
        self.assertEqual(parser.parse_known_args('0.5 1alias2 b'.split()),
            (NS(foo=False, bar=0.5, w=None, x='b'), []))
...
class TestParentParsers(TestCase):
    ...
    def test_single_parent(self):
        ...
        self.assertEqual(parser.parse_args('-y 1 2 --w 3'.split()), NS(w=
            '3', y='1', z='2'))
    ...
    def test_multiple_parents(self):
        ...
        self.assertEqual(parser.parse_args('--d 1 --w 2 3 4'.split()), NS(a
            ='3', b=None, d='1', w='2', y=None, z='4'))

    def test_multiple_parents_mutex(self):
        parents = [self.ab_mutex_parent, self.wxyz_parent]
        parser = ErrorRaisingArgumentParser(parents=parents)
        self.assertEqual(parser.parse_args('-a --w 2 3'.split()), NS(a=True,
            b=False, w='2', y=None, z='3'))
    ...
    def test_conflicting_parents(self):
        self.assertRaises(argparse.ArgumentError, argparse.ArgumentParser,
    ...
    def test_same_argument_name_parents(self):
        ...
        parser = ErrorRaisingArgumentParser(parents=parents)
        self.assertEqual(parser.parse_args('1 2'.split()), NS(w=None, y=
            None, z='2'))
    ...
    def test_subparser_parents_mutex(self):
        ...
        self.assertEqual(parser.parse_args('foo -a 4'.split()), NS(a=True,
            b=False, c='4'))
        self.assertEqual(parser.parse_args('bar -b  --w 2 3 4'.split()), NS
            (a=False, b=True, w='2', y=None, z='3', e='4'))
    ...
    def test_groups_parents(self):
        ...
        self.assertRaises(ArgumentParserError, parser.parse_args, ['-y',
            'Y', '-z', 'Z'])
        parser_help = parser.format_help()
        progname = self.main_program
        self.assertEqual(parser_help, textwrap.dedent(
...
class TestMutuallyExclusiveSimple(MEMixin, TestCase):
    ...
    successes = [('--bar X', NS(bar='X', baz=None)), ('--bar X --bar Z', NS
        (bar='Z', baz=None)), ('--baz Y', NS(bar=None, baz='Y')), ('--baz',
        NS(bar=None, baz='Z'))]
...
class TestMutuallyExclusiveLong(MEMixin, TestCase):
    ...
    successes = [('--klmno X', NS(abcde=None, fghij=None, klmno='X', pqrst=
        None)), ('--abcde Y --klmno X', NS(abcde='Y', fghij=None, klmno='X',
        pqrst=None)), ('--pqrst X', NS(abcde=None, fghij=None, klmno=None,
        pqrst='X')), ('--pqrst X --fghij Y', NS(abcde=None, fghij='Y',
        klmno=None, pqrst='X'))]
    successes_when_not_required = [('', NS(abcde=None, fghij=None, klmno=
        None, pqrst=None))]
...
class TestMutuallyExclusiveFirstSuppressed(MEMixin, TestCase):
    ...
    def get_parser(self, required):
        ...
        return parser
    failures = ['-x X -y']
    successes = [('-x X', NS(x='X', y=True)), ('-x X -x Y', NS(x='Y', y=
        True)), ('-y', NS(x=None, y=False))]
...
class TestMutuallyExclusiveManySuppressed(MEMixin, TestCase):
    ...
    successes = [('--spam', NS(spam=True, badger=True, bladder=None)), (
    ...
    successes_when_not_required = [('', NS(spam=False, badger=True, bladder
        =None))]
...
class TestMutuallyExclusiveOptionalAndPositional(MEMixin, TestCase):
    ...
    def get_parser(self, required):
        ...
        return parser
    failures = ['--foo --spam S', '--spam S X', 'X --foo', 'X Y Z --spam S',
        '--foo X Y']
    successes = [('--foo', NS(foo=True, spam=None, badger='X')), (
        '--spam S', NS(foo=False, spam='S', badger='X')), ('X', NS(foo=
        False, spam=None, badger=['X'])), ('X Y Z', NS(foo=False, spam=None,
        badger=['X', 'Y', 'Z']))]
...
class TestMutuallyExclusiveOptionalsMixed(MEMixin, TestCase):
    ...
    successes = [('-a', NS(a=True, b=False, c=False, x=False, y=False)), (
        '-b', NS(a=False, b=True, c=False, x=False, y=False)), ('-c', NS(a=
        False, b=False, c=True, x=False, y=False)), ('-a -x', NS(a=True, b=
        False, c=False, x=True, y=False)), ('-y -b', NS(a=False, b=True, c=
        False, x=False, y=True)), ('-x -y -c', NS(a=False, b=False, c=True,
        x=True, y=True))]
    successes_when_not_required = [('', NS(a=False, b=False, c=False, x=
        False, y=False)), ('-x', NS(a=False, b=False, c=False, x=True, y=
        False)), ('-y', NS(a=False, b=False, c=False, x=False, y=True))]
...
class TestMutuallyExclusiveInGroup(MEMixin, TestCase):
    ...
    def get_parser(self, required=None):
        parser = ErrorRaisingArgumentParser(prog='PROG')
        titled_group = parser.add_argument_group(title='Titled group',
            description='Group description')
        mutex_group = titled_group.add_mutually_exclusive_group(required=
            required)
        mutex_group.add_argument('--bar', help='bar help')
        mutex_group.add_argument('--baz', help='baz help')
        return parser
    failures = ['--bar X --baz Y', '--baz X --bar Y']
    successes = [('--bar X', NS(bar='X', baz=None)), ('--baz Y', NS(bar=
        None, baz='Y'))]
    successes_when_not_required = [('', NS(bar=None, baz=None))]
    usage_when_not_required = (
        '        usage: PROG [-h] [--bar BAR | --baz BAZ]\n        ')
...
class TestMutuallyExclusiveOptionalsAndPositionalsMixed(MEMixin, TestCase):
    ...
    successes = [('X A', NS(a='A', b=False, c=False, x='X', y=False)), (
        'X -b', NS(a=None, b=True, c=False, x='X', y=False)), ('X -c', NS(a
        =None, b=False, c=True, x='X', y=False)), ('X A -y', NS(a='A', b=
        False, c=False, x='X', y=True)), ('X -y -b', NS(a=None, b=True, c=
        False, x='X', y=True))]
    successes_when_not_required = [('X', NS(a=None, b=False, c=False, x='X',
        y=False)), ('X -y', NS(a=None, b=False, c=False, x='X', y=True))]
...
class MEPBase(object):
    ...
    def get_parser(self, required=None):
        ...
        parser = ErrorRaisingArgumentParser(prog=parent.prog, add_help=
            False, parents=[parent])
        return parser


class TestMutuallyExclusiveGroupErrorsParent(MEPBase,
...
class TestMutuallyExclusiveFirstSuppressedParent(MEPBase,
    TestMutuallyExclusiveFirstSuppressed):
    pass


class TestMutuallyExclusiveManySuppressedParent(MEPBase,
    TestMutuallyExclusiveManySuppressed):
    pass


class TestMutuallyExclusiveOptionalAndPositionalParent(MEPBase,
    TestMutuallyExclusiveOptionalAndPositional):
    pass


class TestMutuallyExclusiveOptionalsMixedParent(MEPBase,
    TestMutuallyExclusiveOptionalsMixed):
    pass


class TestMutuallyExclusiveOptionalsAndPositionalsMixedParent(MEPBase,
...
class TestSetDefaults(TestCase):
    ...
    def test_set_defaults_no_args(self):
        ...
        self.assertEqual(NS(x='baz', y='bar', z=1), parser.parse_args([],
            NS(x='baz')))
        self.assertEqual(NS(x='baz', y='bar', z=2), parser.parse_args([],
            NS(x='baz', z=2)))
    ...
    def test_set_defaults_with_args(self):
        ...
        self.assertEqual(NS(x='baz', y='bar'), parser.parse_args([], NS(x=
            'baz')))
    ...
    def test_set_defaults_same_as_add_argument(self):
        ...
        self.assertEqual(NS(w='W', x='XX', y='Y', z='ZZ'), parser.
            parse_args([]))
        parser.set_defaults(w='WW', x='X', y='YY', z='Z')
        self.assertEqual(NS(w='WW', x='X', y='YY', z='Z'), parser.
            parse_args([]))
    ...
    def __init__(cls, name, bases, bodydict):
        ...
        class AddTests(object):
            ...
            def __init__(self, test_class, func_suffix, std_name):
                ...
                for test_func in [self.test_format, self.test_print, self.
                    test_print_file]:
            ...
            def _get_parser(self, tester):
                parser = argparse.ArgumentParser(*tester.parser_signature.
                    args, **tester.parser_signature.kwargs)
                for argument_sig in getattr(tester, 'argument_signatures', []):
                    parser.add_argument(*argument_sig.args, **argument_sig.
                        kwargs)
...
class TestHelpBiggerOptionals(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG', description='DESCRIPTION', epilog=
        'EPILOG')
    argument_signatures = [Sig('-v', '--version', action='version', version
        ='0.1'), Sig('-x', action='store_true', help='X HELP'), Sig('--y',
        help='Y HELP'), Sig('foo', help='FOO HELP'), Sig('bar', help=
        'BAR HELP')]
...
class TestHelpBiggerOptionalGroups(HelpTestCase):
    ...
    argument_signatures = [Sig('-v', '--version', action='version', version
        ...
        help='Y HELP'), Sig('foo', help='FOO HELP'), Sig('bar', help=
        'BAR HELP')]
    argument_group_signatures = [(Sig('GROUP TITLE', description=
        'GROUP DESCRIPTION'), [Sig('baz', help='BAZ HELP'), Sig('-z', nargs
        ='+', help='Z HELP')])]
    usage = (
...
class TestHelpBiggerPositionals(HelpTestCase):
    ...
    argument_signatures = [Sig('-x', action='store_true', help='X HELP'),
        Sig('--y', help='Y HELP'), Sig('ekiekiekifekang', help='EKI HELP'),
...
class TestHelpReformatting(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG', description=
        """   oddly    formatted
description

that is so long that it should go onto multiple lines when wrapped"""
        )
    argument_signatures = [Sig('-x', metavar='XX', help=
        """oddly
    formatted -x help"""), Sig('y', metavar='yyy', help=
        'normal y help')]
    argument_group_signatures = [(Sig('title', description=
        """
    oddly formatted group

description"""), [Sig('-a', action=
        'store_true', help=
        """ oddly 
formatted    -a  help  
...
class TestHelpWrappingShortNames(HelpTestCase):
    ...
    argument_signatures = [Sig('-x', metavar='XX', help='XHH HX' * 20), Sig
        ('y', metavar='yyy', help='YH YH' * 20)]
    argument_group_signatures = [(Sig('ALPHAS'), [Sig('-a', action=
...
class TestHelpWrappingLongNames(HelpTestCase):
    ...
    argument_signatures = [Sig('-v', '--version', action='version', version
        ='V V' * 30), Sig('-x', metavar='X' * 25, help='XH XH' * 20), Sig(
        'y', metavar='y' * 25, help='YH YH' * 20)]
    argument_group_signatures = [(Sig('ALPHAS'), [Sig('-a', metavar='A' * 
        25, help='AH AH' * 20), Sig('z', metavar='z' * 25, help='ZH ZH' * 20)])
        ]
    usage = '        usage: USAGE\n        '
    help = usage + """
        D DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD DD
...
class TestHelpUsage(HelpTestCase):
    ...
    argument_signatures = [Sig('-w', nargs='+', help='w'), Sig('-x', nargs=
        '*', help='x'), Sig('a', help='a'), Sig('b', help='b', nargs=2),
        Sig('c', help='c', nargs='?')]
    argument_group_signatures = [(Sig('group'), [Sig('-y', nargs='?', help=
        'y'), Sig('-z', nargs=3, help='z'), Sig('d', help='d', nargs='*'),
        Sig('e', help='e', nargs='+')])]
...
class TestHelpOnlyUserGroups(HelpTestCase):
    ...
    argument_signatures = []
    argument_group_signatures = [(Sig('xxxx'), [Sig('-x', help='x'), Sig(
        'a', help='a')]), (Sig('yyyy'), [Sig('b', help='b'), Sig('-y', help
        ='y')])]
...
class TestHelpUsageLongProg(HelpTestCase):
    ...
    argument_signatures = [Sig('-w', metavar='W'), Sig('-x', metavar='X'),
        Sig('a'), Sig('b')]
    argument_group_signatures = []
...
class TestHelpUsageLongProgOptionsWrap(HelpTestCase):
    ...
    parser_signature = Sig(prog='P' * 60)
    argument_signatures = [Sig('-w', metavar='W' * 25), Sig('-x', metavar=
        'X' * 25), Sig('-y', metavar='Y' * 25), Sig('-z', metavar='Z' * 25),
        Sig('a'), Sig('b')]
    argument_group_signatures = []
    usage = """        usage: PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP
...
class TestHelpUsagePositionalsWrap(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG')
    argument_signatures = [Sig('-x'), Sig('-y'), Sig('-z'), Sig('a' * 25),
        Sig('b' * 25), Sig('c' * 25)]
    argument_group_signatures = []
...
class TestHelpUsageOptionalsPositionalsWrap(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG')
    argument_signatures = [Sig('-x', metavar='X' * 25), Sig('-y', metavar=
        'Y' * 25), Sig('-z', metavar='Z' * 25), Sig('a' * 25), Sig('b' * 25
        ), Sig('c' * 25)]
    argument_group_signatures = []
...
class TestHelpVariableExpansion(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG')
    argument_signatures = [Sig('-x', type=int, help=
        'x %(prog)s %(default)s %(type)s %%'), Sig('-y', action=
        'store_const', default=42, const='XXX', help=
        'y %(prog)s %(default)s %(const)s'), Sig('--foo', choices='abc',
        help='foo %(prog)s %(default)s %(choices)s'), Sig('--bar', default=
        'baz', choices=[1, 2], metavar='BBB', help=
        'bar %(prog)s %(default)s %(dest)s'), Sig('spam', help=
        'spam %(prog)s %(default)s'), Sig('badger', default=0.5, help=
        'badger %(prog)s %(default)s')]
    argument_group_signatures = [(Sig('group'), [Sig('-a', help=
        'a %(prog)s %(default)s'), Sig('-b', default=-1, help=
        'b %(prog)s %(default)s')])]
...
class TestHelpSuppressUsage(HelpTestCase):
    ...
    argument_signatures = [Sig('--foo', help='foo help'), Sig('spam', help=
        'spam help')]
    argument_group_signatures = []
...
class TestHelpSuppressOptional(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG', add_help=False)
    argument_signatures = [Sig('--foo', help=argparse.SUPPRESS), Sig('spam',
        help='spam help')]
    argument_group_signatures = []
...
class TestHelpSuppressOptionalGroup(HelpTestCase):
    ...
    argument_signatures = [Sig('--foo', help='foo help'), Sig('spam', help=
        'spam help')]
    argument_group_signatures = [(Sig('group'), [Sig('--bar', help=argparse
        .SUPPRESS)])]
...
class TestHelpAlternatePrefixChars(HelpTestCase):
    ...
    argument_signatures = [Sig('^^foo', action='store_true', help=
        'foo help'), Sig(';b', ';;bar', help='bar help')]
    argument_group_signatures = []
...
class TestHelpTupleMetavar(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG')
    argument_signatures = [Sig('-w', help='w', nargs='+', metavar=('W1',
        'W2')), Sig('-x', help='x', nargs='*', metavar=('X1', 'X2')), Sig(
        '-y', help='y', nargs=3, metavar=('Y1', 'Y2', 'Y3')), Sig('-z',
        help='z', nargs='?', metavar=('Z1',))]
    argument_group_signatures = []
...
class TestHelpRawText(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG', formatter_class=argparse.
        RawTextHelpFormatter, description=
        """Keep the formatting
    exactly as it is written

here
""")
    argument_signatures = [Sig('--foo', help=
        '    foo help should also\nappear as given here'), Sig('spam', help
        ='spam help')]
    argument_group_signatures = [(Sig('title', description=
        """    This text
  should be indented
...
""")
    argument_signatures = [Sig('--foo', help=
        """  foo help should not
    retain this odd formatting"""), Sig(
        'spam', help='spam help')]
    argument_group_signatures = [(Sig('title', description=
        """    This text
  should be indented
...
class TestHelpArgumentDefaults(HelpTestCase):
    ...
    argument_signatures = [Sig('--foo', help=
        'foo help - oh and by the way, %(default)s'), Sig('--bar', action=
        'store_true', help='bar help'), Sig('spam', help='spam help'), Sig(
        'badger', nargs='?', default='wooden', help='badger help')]
    argument_group_signatures = [(Sig('title', description='description'),
...
class TestHelpVersionActionSuppress(HelpTestCase):
    ...
    parser_signature = Sig(prog='PROG')
    argument_signatures = [Sig('-v', '--version', action='version', version
        ='1.0', help=argparse.SUPPRESS), Sig('--foo', help='foo help'), Sig
        ('spam', help='spam help')]
    argument_group_signatures = []
    usage = '        usage: PROG [-h] [--foo FOO] spam\n        '
    help = usage + """
...
class TestHelpSubparsersWithHelpOrdering(HelpTestCase):
    ...
    argument_signatures = [Sig('-v', '--version', action='version', version
        ='0.1')]
    subcommand_data = ('a', 'a subcommand help'), ('b', 'b subcommand help'), (
        'c', 'c subcommand help'), ('d', 'd subcommand help'), ('e',
        'e subcommand help')
    subparsers_signatures = [Sig(name=name, help=help) for name, help in
        subcommand_data]
    usage = '        usage: PROG [-h] [-v] {a,b,c,d,e} ...\n        '
    help = usage + """
        display some subcommands
...
class TestHelpMetavarTypeFormatter(HelpTestCase):
    ...
    argument_signatures = [Sig('a', type=int), Sig('-b', type=custom_type),
...
class TestInvalidArgumentConstructors(TestCase):
    ...
    def test_multiple_dest(self):
        ...
        self.assertIn('dest supplied twice for positional argument', str(cm
            .exception))
    ...
    def test_more_than_one_argument_actions(self):
        for action in ['store', 'append']:
            ...
            for nargs in [1, '*', '+']:
                self.assertValueError('-x', const='foo', nargs=nargs,
                    action=action)
                self.assertValueError('spam', const='foo', nargs=nargs,
                    action=action)
    ...
    def test_parsers_action_missing_params(self):
        ...
        self.assertTypeError('command', action='parsers', parser_class=
    ...
    def test_user_defined_action(self):
        ...
        class Action(object):
            ...
            def __call__(self, *args, **kwargs):
                pass
        parser = argparse.ArgumentParser()
        self.assertRaises(Success, parser.add_argument, '--spam', action=
            Action, default=Success, const=Success)
        self.assertRaises(Success, parser.add_argument, 'spam', action=
            Action, default=Success, const=Success)
...
class TestActionsReturned(TestCase):
    ...
    def test_misc(self):
        parser = argparse.ArgumentParser()
        action = parser.add_argument('--foo', nargs='?', const=42, default=
            84, type=int, choices=[1, 2], help='FOO', metavar='BAR', dest='baz'
            )
...
class TestStrings(TestCase):
    ...
    def test_optional(self):
        option = argparse.Action(option_strings=['--foo', '-a', '-b'], dest
            ='b', type='int', nargs='+', default=42, choices=[1, 2, 3],
            help='HELP', metavar='METAVAR')
        string = (
            "Action(option_strings=['--foo', '-a', '-b'], dest='b', nargs='+', const=None, default=42, type='int', choices=[1, 2, 3], help='HELP', metavar='METAVAR')"
            )
        self.assertStringEqual(option, string)

    def test_argument(self):
        argument = argparse.Action(option_strings=[], dest='x', type=float,
            nargs='?', default=2.5, choices=[0.5, 1.5, 2.5], help='H HH H',
            metavar='MV MV MV')
        string = (
...
class TestImportStar(TestCase):
    ...
    def test_all_exports_everything_but_modules(self):
        items = [name for name, value in vars(argparse).items() if not (
            name.startswith('_') or name == 'ngettext') if not inspect.
            ismodule(value)]
