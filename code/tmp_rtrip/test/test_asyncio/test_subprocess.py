...
PROGRAM_CAT = [sys.executable, '-c', ';'.join(('import sys',
...
class SubprocessTransportTests(test_utils.TestCase):
    ...
    def create_transport(self, waiter=None):
        ...
        transport = TestSubprocessTransport(self.loop, protocol, ['test'],
            False, None, None, None, 0, waiter=waiter)
    ...
    def test_proc_exited(self):
        ...
        self.assertRaises(ProcessLookupError, transport.send_signal, signal
            .SIGTERM)
...
class SubprocessMixin:
    ...
    def test_stdin_stdout(self):
        ...
        @asyncio.coroutine
        def run(data):
            proc = yield from asyncio.create_subprocess_exec(*args, stdin=
                subprocess.PIPE, stdout=subprocess.PIPE, loop=self.loop)
    ...
    def test_start_new_session(self):
        create = asyncio.create_subprocess_shell('exit 8',
            start_new_session=True, loop=self.loop)
        proc = self.loop.run_until_complete(create)
        exitcode = self.loop.run_until_complete(proc.wait())
    ...
    def test_send_signal(self):
        ...
        create = asyncio.create_subprocess_exec(*args, stdout=subprocess.
            PIPE, loop=self.loop)
        proc = self.loop.run_until_complete(create)
    ...
    def prepare_broken_pipe_test(self):
        ...
        create = asyncio.create_subprocess_exec(sys.executable, '-c',
            'pass', stdin=subprocess.PIPE, loop=self.loop)
        proc = self.loop.run_until_complete(create)
    ...
    def test_stdin_broken_pipe(self):
        ...
        with test_utils.disable_logger():
            self.assertRaises((BrokenPipeError, ConnectionResetError), self
    ...
    def test_pause_reading(self):
        ...
        def test_pause_reading():
            code = '\n'.join(('import sys', 'sys.stdout.write("x" * %s)' %
                size, 'sys.stdout.flush()'))
            ...
            proc = yield from asyncio.create_subprocess_exec(sys.executable,
                '-c', code, stdin=asyncio.subprocess.PIPE, stdout=asyncio.
                subprocess.PIPE, limit=limit, loop=self.loop)
    ...
    def test_stdin_not_inheritable(self):
        ...
        def len_message(message):
            ...
            proc = yield from asyncio.create_subprocess_exec(sys.executable,
                '-c', code, stdin=asyncio.subprocess.PIPE, stdout=asyncio.
                subprocess.PIPE, stderr=asyncio.subprocess.PIPE, close_fds=
    ...
    def test_cancel_process_wait(self):
        ...
        def cancel_wait():
            proc = yield from asyncio.create_subprocess_exec(*
                PROGRAM_BLOCKED, loop=self.loop)
    ...
    def test_cancel_make_subprocess_transport_exec(self):
        ...
        def cancel_make_transport():
            coro = asyncio.create_subprocess_exec(*PROGRAM_BLOCKED, loop=
                self.loop)
    ...
    def test_close_dont_kill_finished(self):
        ...
        if sys.platform != 'win32' and isinstance(self,
    ...
    def test_read_stdout_after_process_exit(self):
        ...
        @asyncio.coroutine
        def execute():
            code = '\n'.join(['import sys', 'for _ in range(64):',
...
if sys.platform != 'win32':
    ...
    class SubprocessSafeWatcherTests(SubprocessWatcherMixin, test_utils.
        TestCase):
        Watcher = unix_events.SafeChildWatcher


    class SubprocessFastWatcherTests(SubprocessWatcherMixin, test_utils.
        TestCase):
