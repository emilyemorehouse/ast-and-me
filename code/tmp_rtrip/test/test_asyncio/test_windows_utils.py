...
class WinsocketpairTests(unittest.TestCase):
    ...
    def test_winsocketpair_invalid_args(self):
        self.assertRaises(ValueError, windows_utils.socketpair, family=
            socket.AF_UNSPEC)
        self.assertRaises(ValueError, windows_utils.socketpair, type=socket
            .SOCK_DGRAM)
...
class PopenTests(unittest.TestCase):
    ...
    def test_popen(self):
        command = """if 1:
            ...
            """
        msg = b'blah\n'
        p = windows_utils.Popen([sys.executable, '-c', command], stdin=
            windows_utils.PIPE, stdout=windows_utils.PIPE, stderr=
            windows_utils.PIPE)
