...
class ComparableException:
    ...
    def __eq__(self, anExc):
        ...
        return (self.err.__class__ == anExc.__class__ and self.err.args ==
            anExc.args)
...
parse_strict_test_cases = [('', ValueError("bad query field: ''")), ('&',
    ValueError("bad query field: ''")), ('&&', ValueError(
    "bad query field: ''")), (';', ValueError("bad query field: ''")), (
    ';&;', ValueError("bad query field: ''")), ('=', {}), ('=&=', {}), (
    '=;=', {}), ('=a', {'': ['a']}), ('&=a', ValueError(
    "bad query field: ''")), ('=a&', ValueError("bad query field: ''")), (
    '=&a', ValueError("bad query field: 'a'")), ('b=a', {'b': ['a']}), (
    'b+=a', {'b ': ['a']}), ('a=b=a', {'a': ['b=a']}), ('a=+b=a', {'a': [
    ' b=a']}), ('&b=a', ValueError("bad query field: ''")), ('b&=a',
    ValueError("bad query field: 'b'")), ('a=a+b&b=b+c', {'a': ['a b'], 'b':
    ['b c']}), ('a=a+b&a=b+a', {'a': ['a b', 'b a']}), (
    'x=1&y=2.0&z=2-3.%2b0', {'x': ['1'], 'y': ['2.0'], 'z': ['2-3.+0']}), (
    'x=1;y=2.0&z=2-3.%2b0', {'x': ['1'], 'y': ['2.0'], 'z': ['2-3.+0']}), (
    'x=1;y=2.0;z=2-3.%2b0', {'x': ['1'], 'y': ['2.0'], 'z': ['2-3.+0']}), (
    'Hbc5161168c542333633315dee1182227:key_store_seqid=400006&cuyer=r&view=bustomer&order_id=0bb2e248638833d48cb7fed300000f1b&expire=964546263&lobale=en-US&kid=130003.300038&ss=env'
    , {'Hbc5161168c542333633315dee1182227:key_store_seqid': ['400006'],
    'cuyer': ['r'], 'expire': ['964546263'], 'kid': ['130003.300038'],
    'lobale': ['en-US'], 'order_id': ['0bb2e248638833d48cb7fed300000f1b'],
    'ss': ['env'], 'view': ['bustomer']}), (
    'group_id=5470&set=custom&_assigned_to=31392&_status=1&_category=100&SUBMIT=Browse'
    , {'SUBMIT': ['Browse'], '_assigned_to': ['31392'], '_category': ['100'
    ], '_status': ['1'], 'group_id': ['5470'], 'set': ['custom']})]
...
class CgiTests(unittest.TestCase):
    ...
    def test_parse_multipart(self):
        ...
        expected = {'submit': [b' Add '], 'id': [b'1234'], 'file': [
            b'Testing 123.\n'], 'title': [b'']}
    ...
    def test_escape(self):
        with warnings.catch_warnings():
            ...
            self.assertEqual('&quot;test string&quot;', cgi.escape(
                '"test string"', True))

    def test_strict(self):
        for orig, expect in parse_strict_test_cases:
            d = do_test(orig, 'GET')
            self.assertEqual(d, expect, 'Error parsing %s method GET' %
                repr(orig))
            d = do_test(orig, 'POST')
            self.assertEqual(d, expect, 'Error parsing %s method POST' %
                repr(orig))
    ...
    def test_log(self):
        ...
        self.assertEqual(cgi.logfp.getvalue(),
            'Testing initlog 1\nTesting log 2\n')
    ...
    def test_fieldstorage_multipart(self):
        ...
        expect = [{'name': 'id', 'filename': None, 'value': '1234'}, {
            'name': 'title', 'filename': None, 'value': ''}, {'name':
            'file', 'filename': 'test.txt', 'value': b'Testing 123.\n'}, {
...
"""
                .replace('\n', '\r\n') % content)
            environ = {'CONTENT_LENGTH': str(len(data)), 'CONTENT_TYPE':
                'multipart/form-data; boundary=-123', 'REQUEST_METHOD': 'POST'}
    ...
    def test_fieldstorage_multipart_w3c(self):
        ...
        expect = [{'name': None, 'filename': 'file1.txt', 'value':
            b'... contents of file1.txt ...'}, {'name': None, 'filename':
            'file2.gif', 'value': b'...contents of file2.gif...'}]
...
--JfISa01"""
    ...
    def test_fieldstorage_as_context_manager(self):
        ...
        with self.assertRaisesRegex(ValueError, 'I/O operation on closed file'
            ...
            fs.file.read()
    _qs_result = {'key1': 'value1', 'key2': ['value2x', 'value2y'], 'key3':
        'value3', 'key4': 'value4'}
    ...
    def testQSAndUrlEncode(self):
        ...
        environ = {'CONTENT_LENGTH': str(len(data)), 'CONTENT_TYPE':
            ...
            'key1=value1&key2=value2y', 'REQUEST_METHOD': 'POST'}
...
"""
        environ = {'CONTENT_LENGTH': str(len(data)), 'CONTENT_TYPE':
            'multipart/form-data; boundary=-123', 'QUERY_STRING':
            'key1=value1&key2=value2x', 'REQUEST_METHOD': 'POST'}
        v = gen_result(data, environ)
        self.assertEqual(self._qs_result, v)
...
"""
    ...
    def test_deprecated_parse_qs(self):
        with check_warnings((
            ...
            DeprecationWarning)):
            self.assertEqual({'a': ['A1'], 'B': ['B3'], 'b': ['B2']}, cgi.
    ...
    def test_deprecated_parse_qsl(self):
        with check_warnings((
            ...
            DeprecationWarning)):
            self.assertEqual([('a', 'A1'), ('b', 'B2'), ('B', 'B3')], cgi.
                parse_qsl('a=A1&b=B2&B=B3'))

    def test_parse_header(self):
        self.assertEqual(cgi.parse_header('text/plain'), ('text/plain', {}))
        self.assertEqual(cgi.parse_header('text/vnd.just.made.this.up ; '),
            ('text/vnd.just.made.this.up', {}))
        self.assertEqual(cgi.parse_header('text/plain;charset=us-ascii'), (
            'text/plain', {'charset': 'us-ascii'}))
        self.assertEqual(cgi.parse_header('text/plain ; charset="us-ascii"'
            ), ('text/plain', {'charset': 'us-ascii'}))
        self.assertEqual(cgi.parse_header(
        ...
        self.assertEqual(cgi.parse_header(
            ...
            'silly.txt'}))
        self.assertEqual(cgi.parse_header(
            'attachment; filename="strange;name"'), ('attachment', {
