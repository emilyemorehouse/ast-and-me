...
class TestEUCJPCOMPATMap(multibytecodec_support.TestBase_Mapping, unittest.
    TestCase):
    encoding = 'euc_jp'
...
class TestSJISCOMPATMap(multibytecodec_support.TestBase_Mapping, unittest.
    TestCase):
    encoding = 'shift_jis'
...
class TestEUCJISX0213Map(multibytecodec_support.TestBase_Mapping, unittest.
    TestCase):
...
class TestSJISX0213Map(multibytecodec_support.TestBase_Mapping, unittest.
    TestCase):
