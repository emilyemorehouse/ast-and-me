...
class TestCopy(unittest.TestCase):
    ...
    def test_copy_atomic(self):
        ...
        class WithMetaclass(metaclass=abc.ABCMeta):
            pass
        tests = [None, ..., NotImplemented, 42, 2 ** 100, 3.14, True, False,
            1j, 'hello', 'helloሴ', f.__code__, b'world', bytes(range(256)),
            range(10), slice(1, 10, 2), NewStyle, Classic, max, WithMetaclass]
        for x in tests:
    ...
    def test_deepcopy_atomic(self):
        ...
        def f():
            pass
        tests = [None, 42, 2 ** 100, 3.14, True, False, 1j, 'hello',
            'helloሴ', f.__code__, NewStyle, Classic, max]
        for x in tests:
