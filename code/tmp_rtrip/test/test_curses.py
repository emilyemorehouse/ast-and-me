...
def requires_curses_func(name):
    return unittest.skipUnless(hasattr(curses, name), 'requires curses.%s' %
        name)
...
class TestCurses(unittest.TestCase):
    ...
    def test_window_funcs(self):
        ...
        for meth in [stdscr.addch, stdscr.addstr]:
            for args in ['a', ('a', curses.A_BOLD), (4, 4, 'a'), (5, 5, 'a',
                curses.A_BOLD)]:
                with self.subTest(meth=meth.__qualname__, args=args):
                    meth(*args)
        for meth in [stdscr.box, stdscr.clear, stdscr.clrtobot, stdscr.
            clrtoeol, stdscr.cursyncup, stdscr.delch, stdscr.deleteln,
            stdscr.erase, stdscr.getbegyx, stdscr.getbkgd, stdscr.getkey,
            stdscr.getmaxyx, stdscr.getparyx, stdscr.getyx, stdscr.inch,
            stdscr.insertln, stdscr.instr, stdscr.is_wintouched, win.
            noutrefresh, stdscr.redrawwin, stdscr.refresh, stdscr.standout,
            stdscr.standend, stdscr.syncdown, stdscr.syncup, stdscr.
            touchwin, stdscr.untouchwin]:
    ...
    def test_module_funcs(self):
        ...
        for func in [curses.baudrate, curses.beep, curses.can_change_color,
            curses.cbreak, curses.def_prog_mode, curses.doupdate, curses.
            filter, curses.flash, curses.flushinp, curses.has_colors,
            curses.has_ic, curses.has_il, curses.isendwin, curses.killchar,
            curses.longname, curses.nocbreak, curses.noecho, curses.nonl,
            curses.noqiflush, curses.noraw, curses.reset_prog_mode, curses.
            termattrs, curses.termname, curses.erasechar, curses.getsyx]:
    ...
    def test_userptr_without_set(self):
        ...
        with self.assertRaises(curses.panel.error, msg=
    ...
    def test_unget_wch(self):
        ...
        for ch in ('a', 'é', '€', '\U0010ffff'):
            ...
            try:
                ...
                self.fail('unget_wch(%a) failed with encoding %s: %s' % (ch,
                    stdscr.encoding, err))
            read = stdscr.get_wch()
