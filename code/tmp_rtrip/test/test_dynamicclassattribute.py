...
class PropertyTests(unittest.TestCase):
    ...
    def test_property_decorator_subclass_doc(self):
        sub = SubClass()
        self.assertEqual(sub.__class__.__dict__['spam'].__doc__,
            'SubClass.getter')
    ...
    def test_property_decorator_baseclass_doc(self):
        base = BaseClass()
        self.assertEqual(base.__class__.__dict__['spam'].__doc__,
            'BaseClass.getter')
    ...
    def test_property_getter_doc_override(self):
        ...
        self.assertEqual(newgettersub.__class__.__dict__['spam'].__doc__,
            'new docstring')
        newgetter = PropertyNewGetter()
        self.assertEqual(newgetter.spam, 8)
        self.assertEqual(newgetter.__class__.__dict__['spam'].__doc__,
            'new docstring')
...
class PropertySubclassTests(unittest.TestCase):
    ...
    def test_docstring_copy(self):
        ...
        class Foo(object):
            ...
            def spam(self):
                ...
                return 1
        self.assertEqual(Foo.__dict__['spam'].__doc__,
            'spam wrapped in DynamicClassAttribute subclass')
    ...
    def test_property_setter_copies_getter_docstring(self):
        ...
        self.assertEqual(FooSub.__dict__['spam'].__doc__,
            'spam wrapped in DynamicClassAttribute subclass')
