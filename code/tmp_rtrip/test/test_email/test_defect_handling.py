...
class TestDefectsBase:
    ...
    def test_same_boundary_inner_outer(self):
        ...
        self.assertIsInstance(self.get_defects(inner)[0], errors.
    ...
    def test_multipart_no_boundary(self):
        ...
        self.assertIsInstance(self.get_defects(msg)[0], errors.
            NoBoundaryInMultipartDefect)
        self.assertIsInstance(self.get_defects(msg)[1], errors.
    ...
    def test_missing_start_boundary(self):
        ...
        self.assertIsInstance(self.get_defects(bad)[0], errors.
            StartBoundaryNotFoundDefect)
    ...
    def test_first_line_is_continuation_header(self):
        ...
        self.assertEqual(len(self.get_defects(msg)), 1)
        self.assertDefectsEqual(self.get_defects(msg), [errors.
