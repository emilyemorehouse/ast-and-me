...
class TestEmailMessageBase:
    policy = policy.default
    message_params = {'empty_message': ((None, None, 0), (), (), ''),
        'non_mime_plain': ((None, None, 0), (), (), textwrap.dedent(
        """                To: foo@example.com

                simple text body
                """
        )), 'mime_non_text': ((None, None, None), (), (), textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                ...
                bogus body.
                """
        )), 'plain_html_alternative': ((None, 2, 1), (), (1, 2), textwrap.
        dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                ...
                --===--
                """
        )), 'plain_html_mixed': ((None, 2, 1), (), (1, 2), textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                ...
                --===--
                """
        )), 'plain_html_attachment_mixed': ((None, None, 1), (2,), (1, 2),
        textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/mixed; boundary="==="
                ...
                --===--
                """
        )), 'html_text_attachment_mixed': ((None, 2, None), (1,), (1, 2),
        textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/mixed; boundary="==="
                ...
                --===--
                """
        )), 'html_text_attachment_inline_mixed': ((None, 2, 1), (), (1, 2),
        textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/mixed; boundary="==="
                ...
                --===--
                """
        )), 'related': ((0, 1, None), (2,), (1, 2), textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                ...
                --===--
                """
        )), 'related_with_start': ((0, 2, None), (1,), (1, 2), textwrap.
        dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/related; boundary="==="; type=text/html;
                ...
                --===--
                """
        )), 'mixed_alternative_plain_related': ((3, 4, 2), (6, 7), (1, 6, 7
        ), textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/mixed; boundary="==="
                ...
                --===--
                """
        )), 'mixed_related_alternative_plain_html': ((1, 4, 3), (6, 7), (1,
        6, 7), textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/mixed; boundary="==="
                ...
                --===--
                """
        )), 'mixed_related_alternative_plain_html_wrong_order': ((1, None,
        None), (6, 7), (1, 6, 7), textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/mixed; boundary="==="
                ...
                --===--
                """
        )), 'message_rfc822': ((None, None, None), (), (), textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                ...
                """
        )), 'mixed_text_message_rfc822': ((None, None, 1), (2,), (1, 2),
        textwrap.dedent(
        """                To: foo@example.com
                MIME-Version: 1.0
                Content-Type: multipart/mixed; boundary="==="
    ...
    def message_as_get_body(self, body_parts, attachments, parts, msg):
        ...
        self.assertEqual(m.get_body(preferencelist=['related']), expected[
            related])
        ...
        self.assertEqual(m.get_body(preferencelist=('plain', 'html',
            'related')), first(expected[::-1]))
        self.assertEqual(m.get_body(preferencelist=('html', 'plain',
            'related')), first([expected[html], expected[plain], expected[
            related]]))
    ...
    def test_set_content_default_cm_comes_from_policy(self):
        ...
        self.assertEqual(cm.args, ('foo',))
        self.assertEqual(cm.kw, dict(bar=1, k=2))
    subtype_params = ('related', 'no_content', 'succeeds'), ('related',
        'none', 'succeeds'), ('related', 'plain', 'succeeds'), ('related',
        'related', ''), ('related', 'alternative', 'raises'), ('related',
        'mixed', 'raises'), ('alternative', 'no_content', 'succeeds'), (
        'alternative', 'none', 'succeeds'), ('alternative', 'plain', 'succeeds'
        ), ('alternative', 'related', 'succeeds'), ('alternative',
        'alternative', ''), ('alternative', 'mixed', 'raises'), ('mixed',
        'no_content', 'succeeds'), ('mixed', 'none', 'succeeds'), ('mixed',
        'plain', 'succeeds'), ('mixed', 'related', 'succeeds'), ('mixed',
        'alternative', 'succeeds'), ('mixed', 'mixed', '')
    ...
    def subtype_as_make(self, method, subtype, outcome):
        ...
        if outcome in ('', 'raises'):
            self._check_disallowed_subtype_raises(m, method, subtype,
                make_method)
            return
        ...
        if subtype == 'no_content':
            ...
            self.assertEqual(m.items(), msg_headers + [('Content-Type', 
                'multipart/' + method)])
        else:
    ...
    def message_as_clear_content(self, body_parts, attachments, parts, msg):
        m = self._str_msg(msg)
        expected_headers = [h for h in m.keys() if not h.lower().startswith
            ('content-')]
        m.clear_content()
...
class TestEmailMessage(TestEmailMessageBase, TestEmailBase):
    ...
    def test_as_string_allows_maxheaderlen(self):
        ...
        self.assertEqual(len(m.as_string(maxheaderlen=0).strip().splitlines
            ()), 1)
        self.assertEqual(len(m.as_string(maxheaderlen=34).strip().
            splitlines()), 6)
