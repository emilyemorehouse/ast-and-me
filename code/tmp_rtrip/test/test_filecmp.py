...
class FileCompareTestCase(unittest.TestCase):
    ...
    def test_matching(self):
        ...
        self.assertTrue(filecmp.cmp(self.name, self.name_same, shallow=
            False), 'Comparing file to identical file fails')
...
class DirCompareTestCase(unittest.TestCase):
    ...
    def test_cmpfiles(self):
        ...
        self.assertTrue(filecmp.cmpfiles(self.dir, self.dir_same, ['file'],
            shallow=False), 'Comparing directory to same fails')
        with open(os.path.join(self.dir, 'file2'), 'w') as output:
            output.write('Different contents.\n')
        self.assertFalse(filecmp.cmpfiles(self.dir, self.dir_same, ['file',
            'file2']) == (['file'], ['file2'], []),
    ...
    def test_dircmp(self):
        ...
        expected_report = ['diff {} {}'.format(self.dir, self.dir_same),
        ...
        self.assertEqual(d.same_files, ['file'])
        self.assertEqual(d.diff_files, [])
        expected_report = ['diff {} {}'.format(self.dir, self.dir_diff),
            "Only in {} : ['file2']".format(self.dir_diff),
            "Identical files : ['file']"]
        self._assert_report(d.report, expected_report)
        left_dir, right_dir = self.dir, self.dir_diff
        shutil.move(os.path.join(self.dir_diff, 'file2'), os.path.join(self
            .dir, 'file2'))
        d = filecmp.dircmp(left_dir, right_dir)
        self.assertEqual(d.left, left_dir)
        self.assertEqual(d.right, right_dir)
