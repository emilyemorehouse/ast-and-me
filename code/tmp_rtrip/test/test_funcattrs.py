...
class FunctionPropertiesTest(FuncAttrsTest):
    ...
    def test___globals__(self):
        ...
        self.cannot_set_attr(self.b, '__globals__', 2, (AttributeError,
            TypeError))
    ...
    def test___qualname__(self):
        ...
        self.assertEqual(FuncAttrsTest.setUp.__qualname__,
            'FuncAttrsTest.setUp')
        ...
        self.assertEqual(inner_global_function.__qualname__,
