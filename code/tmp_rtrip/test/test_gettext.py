...
class PluralFormsTestCase(GettextBaseTest):
    ...
    def test_invalid_syntax(self):
        invalid_expressions = ['x>1', '(n>1', 'n>1)', '42**42**42', '0xa',
            '1.0', '1e2', 'n>0x1', '+n', '-n', 'n()', 'n(1)', '1+', 'nn', 'n n'
            ]
...
class GettextCacheTestCase(GettextBaseTest):
    ...
    def test_cache(self):
        ...
        t = gettext.translation('gettext', self.localedir, class_=
