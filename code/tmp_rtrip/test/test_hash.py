...
class HashEqualityTestCase(unittest.TestCase):
    ...
    def test_coerced_integers(self):
        self.same_hash(int(1), int(1), float(1), complex(1), int('1'),
            float('1.0'))
...
class HashInheritanceTestCase(unittest.TestCase):
    ...
    fixed_expected = [FixedHash(), InheritedHashWithEquality(),
...
class HashBuiltinsTestCase(unittest.TestCase):
    hashes_to_check = [enumerate(range(10)), iter(DefaultIterSeq()), iter(
        lambda : 0, 0)]
...
class StringlikeHashRandomizationTests(HashRandomizationTests):
    repr_ = None
    repr_long = None
    known_hashes = {'djba33x': [[193485960, 193485960, 193485960, 193485960
        ], [-678966196, 573763426263223372, -820489388, -
        4282905804826039665]], 'siphash24': [[1198583518, 
        4596069200710135518, 1198583518, 4596069200710135518], [273876886, 
        -4501618152524544106, 273876886, -4501618152524544106], [-
        ...
        [-1677110816, -2947981342227738144, -1860207793, -
        4296699217652516017]], 'fnv': [[-1600925533, 1453079729188098211, -
        1600925533, 1453079729188098211], [-206076799, -4410911502303878509,
        -1024014457, -3570150969479994130], [811136751, -
        5046230049376118746, -77208053, -4779029615281019666], [44402817, 
        8998297579845987431, -1956240331, -782697888614047887], [-283066365,
        -4576729883824601543, -271871407, -3927695501187247084]]}
...
class StrHashRandomizationTests(StringlikeHashRandomizationTests, unittest.
    TestCase):
    repr_ = repr('abc')
