...
class HashLibTestCase(unittest.TestCase):
    supported_hash_names = ('md5', 'MD5', 'sha1', 'SHA1', 'sha224',
        'SHA224', 'sha256', 'SHA256', 'sha384', 'SHA384', 'sha512',
    ...
    def test_algorithms_guaranteed(self):
        self.assertEqual(hashlib.algorithms_guaranteed, set(_algo for _algo in
            self.supported_hash_names if _algo.islower()))

    def test_algorithms_available(self):
        self.assertTrue(set(hashlib.algorithms_guaranteed).issubset(hashlib
    ...
    def check_blocksize_name(self, name, block_size=0, digest_size=0,
        ...
        for hash_object_constructor in constructors:
            ...
            if digest_length:
                ...
                self.assertEqual(len(m.hexdigest(digest_length)), 2 *
                    digest_length)
            else:
    ...
    def check_blake2(self, constructor, salt_size, person_size, key_size,
        ...
        self.assertEqual(constructor().hexdigest(), constructor(key=b'').
            hexdigest())
        ...
        self.assertRaises(OverflowError, constructor, node_offset=
            max_offset + 1)
        constructor(string=b'', key=b'', salt=b'', person=b'', digest_size=
            17, fanout=1, depth=1, leaf_size=256, node_offset=512,
            node_depth=1, inner_size=7, last_node=True)
    ...
    def test_blake2b(self):
        ...
        self.assertEqual(self.blake2_rfc7693(hashlib.blake2b, b2b_md_len,
            b2b_in_len),
    ...
    def test_blake2s(self):
        ...
        self.assertEqual(self.blake2_rfc7693(hashlib.blake2s, b2s_md_len,
            b2s_in_len),
    ...
    def test_threaded_hashing(self):
        ...
        for threadnum in range(num_threads):
            ...
            events.append(event)
            threading.Thread(target=hash_in_chunks, args=(chunk_size, event)
                ).start()
        for event in events:
            event.wait()
...
class KDFTests(unittest.TestCase):
    pbkdf2_test_vectors = [(b'password', b'salt', 1, None), (b'password',
        b'salt', 2, None), (b'password', b'salt', 4096, None), (
        b'passwordPASSWORDpassword',
        b'saltSALTsaltSALTsaltSALTsaltSALTsalt', 4096, -1), (
        b'pass\x00word', b'sa\x00lt', 4096, 16)]
    scrypt_test_vectors = [(b'', b'', 16, 1, 1, unhexlify(
    ...
    pbkdf2_results = {'sha1': [(bytes.fromhex(
        '0c60c80f961f0e71f3a9b524af6012062fe037a6'), None), (bytes.fromhex(
        'ea6c014dc72d6f8ccd1ed92ace1d41f0d8de8957'), None), (bytes.fromhex(
        '4b007901b765489abead49d926f721d065a429c1'), None), (bytes.fromhex(
        '3d2eec4fe41c849b80c8d83662c0e44a8b291a964cf2f07038'), 25), (bytes.
        fromhex('56fa6aa75548099dcc37d7f03425e0c3'), None)], 'sha256': [(
        bytes.fromhex(
        ...
        ), 40), (bytes.fromhex('89b69d0516f829893c696226650a8687'), None)],
        ...
        ), 64), (bytes.fromhex('9d9e9c4cd21fe4be24d5b8244c759665'), None)]}
    ...
    def _test_pbkdf2_hmac(self, pbkdf2):
        for digest_name, results in self.pbkdf2_results.items():
            for i, vector in enumerate(self.pbkdf2_test_vectors):
                ...
                self.assertEqual(out, expected, (digest_name, password,
                    salt, rounds, dklen))
                out = pbkdf2(digest_name, memoryview(password), memoryview(
                    salt), rounds, dklen)
                out = pbkdf2(digest_name, bytearray(password), bytearray(
                    salt), rounds, dklen)
