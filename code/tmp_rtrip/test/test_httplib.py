...
CERT_selfsigned_pythontestdotnet = os.path.join(here,
...
class HeaderTests(TestCase):
    ...
    def test_content_length_0(self):
        ...
        methods_without_body = ('GET', 'CONNECT', 'DELETE', 'HEAD',
            'OPTIONS', 'TRACE')
        for method in methods_without_body:
            ...
            self.assertEqual(conn._buffer.content_length, None,
        ...
        for method in itertools.chain(methods_without_body, methods_with_body):
            ...
            conn._buffer = ContentLengthChecker()
            conn.request(method, '/', ' ')
            self.assertEqual(conn._buffer.content_length, b'1',
                'Header Content-Length incorrect on {}'.format(method))
    ...
    def test_parse_all_octets(self):
        body = (b"HTTP/1.1 200 OK\r\n!#$%&'*+-.^_`|~: value\r\nVCHAR: " +
            bytes(range(33, 126 + 1)) + b'\r\nobs-text: ' + bytes(range(128,
            255 + 1)) +
            b'\r\nobs-fold: text\r\n folded with space\r\n\tfolded with tab\r\nContent-Length: 0\r\n\r\n'
            )
        sock = FakeSocket(body)
    ...
    def test_invalid_headers(self):
        ...
        conn.putrequest('GET', '/')
        cases = (b'Invalid\r\nName', b'ValidValue'), (b'Invalid\rName',
            b'ValidValue'), (b'Invalid\nName', b'ValidValue'), (
            b'\r\nInvalidName', b'ValidValue'), (b'\rInvalidName',
            b'ValidValue'), (b'\nInvalidName', b'ValidValue'), (b' InvalidName'
            , b'ValidValue'), (b'\tInvalidName', b'ValidValue'), (
            b'Invalid:Name', b'ValidValue'), (b':InvalidName', b'ValidValue'
            ), (b'ValidName', b'Invalid\r\nValue'), (b'ValidName',
            b'Invalid\rValue'), (b'ValidName', b'Invalid\nValue'), (
            b'ValidName', b'InvalidValue\r\n'), (b'ValidName',
            b'InvalidValue\r'), (b'ValidName', b'InvalidValue\n')
...
class TransferEncodingTest(TestCase):
    ...
    def test_explicit_headers(self):
        conn = client.HTTPConnection('example.com')
        conn.sock = FakeSocket(b'')
        conn.request('POST', '/', self._make_body(), {'Transfer-Encoding':
            'chunked'})
        ...
        conn = client.HTTPConnection('example.com')
        conn.sock = FakeSocket(b'')
        conn.request('POST', '/', self.expected_body.decode('latin-1'), {
            'Transfer-Encoding': 'chunked'})
        _, headers, body = self._parse_request(conn.sock.data)
        self.assertNotIn('content-length', [k.lower() for k in headers.keys()])
        self.assertEqual(headers['Transfer-Encoding'], 'chunked')
        ...
        conn = client.HTTPConnection('example.com')
        conn.sock = FakeSocket(b'')
        conn.request('POST', '/', headers={'Transfer-Encoding':
            'gzip, chunked'}, encode_chunked=True, body=self._make_body())
        _, headers, body = self._parse_request(conn.sock.data)
...
class BasicTest(TestCase):
    ...
    def test_host_port(self):
        ...
        for hp, h, p in (('[fe80::207:e9ff:fe9b]:8000',
            'fe80::207:e9ff:fe9b', 8000), ('www.python.org:80',
            'www.python.org', 80), ('www.python.org:', 'www.python.org', 80
    ...
    def test_response_headers(self):
        ...
        hdr = (
            'Customer="WILE_E_COYOTE"; Version="1"; Path="/acme", Part_Number="Rocket_Launcher_0001"; Version="1"; Path="/acme"'
            )
        s = FakeSocket(text)
    ...
    def test_too_many_headers(self):
        headers = '\r\n'.join('Header%d: foo' % i for i in range(client.
            _MAXHEADERS + 1)) + '\r\n'
        text = 'HTTP/1.1 200 OK\r\n' + headers
        s = FakeSocket(text)
        r = client.HTTPResponse(s)
        self.assertRaisesRegex(client.HTTPException,
            'got more than \\d+ headers', r.begin)
    ...
    def test_chunked(self):
        ...
        for n in range(1, 12):
            ...
            resp = client.HTTPResponse(sock, method='GET')
            resp.begin()
            self.assertEqual(resp.read(n) + resp.read(n) + resp.read(),
                expected)
            resp.close()
        for x in ('', 'foo\r\n'):
            ...
            try:
                ...
                expected_message = 'IncompleteRead(%d bytes read)' % len(
                    expected)
    ...
    def test_epipe(self):
        ...
        self.assertEqual('Basic realm="example"', resp.getheader(
            'www-authenticate'))

    def test_overflowing_status_line(self):
        body = 'HTTP/1.1 200 Ok' + 'k' * 65536 + '\r\n'
        resp = client.HTTPResponse(FakeSocket(body))
        self.assertRaises((client.LineTooLong, client.BadStatusLine), resp.
            begin)
    ...
    def test_chunked_extension(self):
        ...
        sock = FakeSocket(chunked_start + extra + last_chunk_extended +
            chunked_end)
        resp = client.HTTPResponse(sock, method='GET')
        resp.begin()
        self.assertEqual(resp.read(), expected)
    ...
    def test_chunked_sync(self):
        ...
        expected = chunked_expected
        extradata = 'extradata'
        sock = FakeSocket(chunked_start + last_chunk + trailers +
            chunked_end + extradata)
        resp = client.HTTPResponse(sock, method='GET')
        resp.begin()
        self.assertEqual(resp.read(), expected)
    ...
    def test_response_fileno(self):
        ...
        serv = socket.socket(socket.AF_INET, socket.SOCK_STREAM, socket.
            IPPROTO_TCP)
...
class OfflineTest(TestCase):
    ...
    def test_client_constants(self):
        expected = ['CONTINUE', 'SWITCHING_PROTOCOLS', 'PROCESSING', 'OK',
            ...
            'EXPECTATION_FAILED', 'UNPROCESSABLE_ENTITY', 'LOCKED',
            'FAILED_DEPENDENCY', 'UPGRADE_REQUIRED',
            'PRECONDITION_REQUIRED', 'TOO_MANY_REQUESTS',
            'REQUEST_HEADER_FIELDS_TOO_LARGE', 'INTERNAL_SERVER_ERROR',
...
class SourceAddressTest(TestCase):
    ...
    def testHTTPConnectionSourceAddress(self):
        self.conn = client.HTTPConnection(HOST, self.port, source_address=(
            '', self.source_port))
        self.conn.connect()
    ...
    def testHTTPSConnectionSourceAddress(self):
        self.conn = client.HTTPSConnection(HOST, self.port, source_address=
            ('', self.source_port))
...
class PersistenceTest(TestCase):
    ...
    def test_disconnected(self):
        ...
        tests = (io.BytesIO, client.RemoteDisconnected), (make_reset_reader,
...
class HTTPSTest(TestCase):
    ...
    def test_networked(self):
        ...
        with support.transient_internet('self-signed.pythontest.net'):
            ...
            with self.assertRaises(ssl.SSLError) as exc_info:
                h.request('GET', '/')
            self.assertEqual(exc_info.exception.reason,
    ...
    def test_host_port(self):
        ...
        for hp, h, p in (('[fe80::207:e9ff:fe9b]:8000',
            'fe80::207:e9ff:fe9b', 8000), ('www.python.org:443',
            'www.python.org', 443), ('www.python.org:', 'www.python.org', 
            443), ('www.python.org', 'www.python.org', 443), (
...
class TunnelTests(TestCase):
    ...
    def test_set_tunnel_host_port_headers(self):
        ...
        self.conn.set_tunnel(tunnel_host, port=tunnel_port, headers=
            tunnel_headers)
