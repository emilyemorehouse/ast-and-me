...
class ImportTests(unittest.TestCase):
    ...
    def test_import_encoded_module(self):
        for modname, encoding, teststr in self.test_strings:
            mod = importlib.import_module('test.encoded_modules.module_' +
                modname)
    ...
    def test_issue1267(self):
        for mod, encoding, _ in self.test_strings:
            fp, filename, info = imp.find_module('module_' + mod, self.
                test_path)
            with fp:
    ...
    def test_issue5604(self):
        ...
        known_locales = {'utf-8': b'\xc3\xa4', 'cp1250': b'\x8c', 'cp1251':
            b'\xc0', 'cp1252': b'\xc0', 'cp1253': b'\xc1', 'cp1254':
            b'\xc0', 'cp1255': b'\xe0', 'cp1256': b'\xe0', 'cp1257':
            b'\xc0', 'cp1258': b'\xc0'}
        ...
        try:
            ...
            with warnings.catch_warnings():
                ...
                if not sys.dont_write_bytecode:
                    mod = imp.load_compiled(temp_mod_name, imp.
                        cache_from_source(temp_mod_name + '.py'))
            self.assertEqual(mod.a, 1)
    ...
    def test_issue9319(self):
        path = os.path.dirname(__file__)
        self.assertRaises(SyntaxError, imp.find_module, 'badsyntax_pep3120',
            [path])
    ...
    def test_bug7732(self):
        with support.temp_cwd():
            ...
            os.mkdir(source)
            self.assertRaisesRegex(ImportError, '^No module', imp.
                find_module, support.TESTFN, ['.'])

    def test_multiple_calls_to_get_data(self):
        loader = imp._LoadSourceCompatibility('imp', imp.__file__, open(imp
            .__file__))
