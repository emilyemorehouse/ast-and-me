...
Frozen_ReturnValue, Source_ReturnValue = util.test_both(ReturnValue,
...
class HandlingFromlist:
    ...
    def test_module_from_package_triggers_ModuleNotFoundError(self):
        ...
        with util.mock_modules('pkg.__init__', 'pkg.mod', module_code={
            'pkg.mod': module_code}) as importer:
            with util.import_state(meta_path=[importer]):
    ...
    def test_star_with_others(self):
        context = util.mock_modules('pkg.__init__', 'pkg.module1',
            'pkg.module2')
...
Frozen_FromList, Source_FromList = util.test_both(HandlingFromlist,
    __import__=util.__import__)
