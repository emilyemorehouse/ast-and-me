...
class RelativeImports:
    ...
    def test_package_to_module(self):
        ...
        globals_ = {'__package__': 'pkg'}, {'__name__': 'pkg', '__path__':
            ['blah']}
    ...
    def test_package_to_package(self):
        ...
        globals_ = {'__package__': 'pkg.subpkg1'}, {'__name__':
            'pkg.subpkg1', '__path__': ['blah']}
    ...
    def test_deep_import(self):
        ...
        for count in range(1, 6):
            create.append('{0}.pkg{1}.__init__'.format(create[-1][:-len(
                '.__init__')], count))
        globals_ = {'__package__': 'pkg.pkg1.pkg2.pkg3.pkg4.pkg5'}, {'__name__'
            : 'pkg.pkg1.pkg2.pkg3.pkg4.pkg5', '__path__': ['blah']}
    ...
    def test_import_from_different_package(self):
        ...
        def callback(global_):
            ...
            module = self.__import__('uncle.cousin', globals_, {}, fromlist
                =['nephew'], level=2)
...
Frozen_RelativeImports, Source_RelativeImports = util.test_both(RelativeImports
