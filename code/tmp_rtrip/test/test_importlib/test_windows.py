...
class WindowsRegistryFinderTests:
    ...
    def test_module_found(self):
        with setup_module(self.machinery, self.test_module):
            loader = self.machinery.WindowsRegistryFinder.find_module(self.
                test_module)
            spec = self.machinery.WindowsRegistryFinder.find_spec(self.
                test_module)
...
class WindowsExtensionSuffixTests:
    ...
    def test_tagged_suffix(self):
        ...
        expected_tag = '.cp{0.major}{0.minor}-{1}.pyd'.format(sys.
            version_info, re.sub('[^a-zA-Z0-9]', '_', get_platform()))
        try:
