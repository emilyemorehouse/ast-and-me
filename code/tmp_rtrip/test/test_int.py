...
L = [('0', 0), ('1', 1), ('9', 9), ('10', 10), ('99', 99), ('100', 100), (
    '314', 314), (' 314', 314), ('314 ', 314), ('  \t\t  314  \t\t  ', 314),
    (repr(sys.maxsize), sys.maxsize), ('  1x', ValueError), ('  1  ', 1), (
    '  1\x02  ', ValueError), ('', ValueError), (' ', ValueError), (
    '  \t\t  ', ValueError), ('Ȁ', ValueError)]
...
class IntTestCases(unittest.TestCase):
        ...
        for base in (object, Classic):
            ...
            for trunc_result_base in (object, Classic):
                ...
                try:
                    ...
                    self.fail('Failed to raise TypeError with %s' % ((base,
                        trunc_result_base),))
    ...
    def test_error_message(self):
        ...
        def check(s, base=None):
            with self.assertRaises(ValueError, msg='int(%r, %r)' % (s, base)
                ) as cm:
                if base is None:
                    int(s)
                else:
            ...
            self.assertEqual(cm.exception.args[0], 
                'invalid literal for int() with base %d: %r' % (10 if base is
                None else base, s))
        check('½')
        check('123½')
        check('  123 456  ')
