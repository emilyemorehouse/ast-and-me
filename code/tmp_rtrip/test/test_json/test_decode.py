...
class TestDecode:
    ...
    def test_object_pairs_hook(self):
        ...
        self.assertEqual(self.json.load(StringIO(s), object_pairs_hook=lambda
            x: x), p)
        ...
        self.assertEqual(self.loads('{}', object_pairs_hook=OrderedDict),
            OrderedDict())
        self.assertEqual(self.loads('{"empty": {}}', object_pairs_hook=
            OrderedDict), OrderedDict([('empty', OrderedDict())]))
