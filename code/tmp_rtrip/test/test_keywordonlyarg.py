...
class KeywordOnlyArgTestCase(unittest.TestCase):
    ...
    def testFunctionCall(self):
        ...
        self.assertEqual(1 + 2 + 3 + 4, keywordonly_and_kwarg_sum(k1=1, k2=
            2, **{'a': 3, 'b': 4}))
        ...
        self.assertEqual(1 + 2 + 3 + 4 + 5 + 6, mixedargs_sum2(1, 2, 3, k1=
            4, k2=5, k3=6))
        self.assertEqual(1 + 2 + 3 + 4 + 5 + 6, mixedargs_sum2(1, 2, 3, k1=
            4, **{'k2': 5, 'k3': 6}))
        ...
        self.assertEqual(['c', 'b', 'a'], sortwords('a', 'c', 'b', reverse=
            True))
        self.assertEqual(['c', 'b', 'a'], sortwords('a', 'c', 'b', reverse=
            True, ignore='ignore'))
