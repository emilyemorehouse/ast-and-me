...
class GetLineTestsBadData(TempFile):
    ...
    def test_getline(self):
        self.assertRaises((SyntaxError, UnicodeDecodeError), linecache.
            getline, self.file_name, 1)

    def test_getlines(self):
        self.assertRaises((SyntaxError, UnicodeDecodeError), linecache.
            getlines, self.file_name)
...
class LineCacheTests(unittest.TestCase):
    ...
    def test_lazycache_smoke(self):
        ...
        linecache.clearcache()
        self.assertEqual(True, linecache.lazycache(NONEXISTENT_FILENAME,
            globals()))
    ...
    def test_lazycache_already_cached(self):
        linecache.clearcache()
        lines = linecache.getlines(NONEXISTENT_FILENAME, globals())
        self.assertEqual(False, linecache.lazycache(NONEXISTENT_FILENAME,
            globals()))
