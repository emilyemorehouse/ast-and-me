...
class AbstractMemoryTests:
    ...
    def test_tobytes(self):
        for tp in self._types:
            ...
            b = m.tobytes()
            expected = b''.join(self.getitem_type(bytes([c])) for c in
                b'abcdef')
...
class BytesMemoryviewTest(unittest.TestCase, BaseMemoryviewTests,
...
class ArrayMemoryviewTest(unittest.TestCase, BaseMemoryviewTests,
...
class BytesMemorySliceTest(unittest.TestCase, BaseMemorySliceTests,
    BaseBytesMemoryTests):
    pass


class ArrayMemorySliceTest(unittest.TestCase, BaseMemorySliceTests,
    BaseArrayMemoryTests):
    pass
