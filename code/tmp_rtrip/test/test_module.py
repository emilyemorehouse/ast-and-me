...
class ModuleTests(unittest.TestCase):
    ...
    def test_uninitialized_missing_getattr(self):
        ...
        self.assertRaisesRegex(AttributeError,
            "module has no attribute 'not_here'", getattr, foo, 'not_here')

    def test_missing_getattr(self):
        foo = ModuleType('foo')
        self.assertRaisesRegex(AttributeError,
            "module 'foo' has no attribute 'not_here'", getattr, foo,
            'not_here')
    ...
    def test_ascii_docstring(self):
        ...
        self.assertEqual(foo.__dict__, {'__name__': 'foo', '__doc__':
            'foodoc', '__loader__': None, '__package__': None, '__spec__':
            None})
    ...
    def test_unicode_docstring(self):
        ...
        self.assertEqual(foo.__dict__, {'__name__': 'foo', '__doc__':
            'foodocሴ', '__loader__': None, '__package__': None, '__spec__':
            None})
    ...
    def test_reinit(self):
        ...
        self.assertEqual(foo.__dict__, {'__name__': 'foo', '__doc__':
            'foodoc', 'bar': 42, '__loader__': None, '__package__': None,
            '__spec__': None})
...
a = A(destroyed)"""
    ...
    def test_module_finalization_at_shutdown(self):
        ...
        self.assertEqual(set(lines), {b'x = a', b'x = b', b'final_a.x = a',
            b'final_b.x = b', b'len = len', b'shutil.rmtree = rmtree'})
