...
class OrderedDictTests:
    ...
    def test_update(self):
        ...
        self.assertEqual(sorted(list(od.items())), [('blue', 6), ('other', 
            7), ('red', 5), ('self', 8)])
        d = OrderedDict([('a', 1), ('b', 2), ('c', 3), ('d', 44), ('e', 55)])
    ...
    def test_iterators(self):
        ...
        self.assertEqual(list(reversed(od.keys())), [t[0] for t in reversed
            (pairs)])
        self.assertEqual(list(reversed(od.values())), [t[1] for t in
            reversed(pairs)])
    ...
    def test_sorted_iterators(self):
        ...
        self.assertEqual(sorted(od.items()), pairs)
        self.assertEqual(sorted(reversed(od)), sorted([t[0] for t in
            reversed(pairs)]))
    ...
    def test_views(self):
        OrderedDict = self.OrderedDict
        s = ('the quick brown fox jumped over a lazy dog yesterday before dawn'
            .split())
...
for method in ('test_init test_update test_abc test_clear test_delitem ' +
