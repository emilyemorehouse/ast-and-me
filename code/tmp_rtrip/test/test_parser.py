...
"""
    ...
    def test_position(self):
        ...
        self.assertEqual([(1, 'def', 1, 0), (1, 'f', 1, 4), (7, '(', 1, 5),
            (1, 'x', 1, 6), (8, ')', 1, 7), (11, ':', 1, 8), (4, '', 1, 9),
            (5, '', 2, -1), (1, 'return', 2, 4), (1, 'x', 2, 11), (14, '+',
            2, 13), (2, '1', 2, 15), (4, '', 2, 16), (6, '', 2, -1), (4, '',
            2, -1), (0, '', 2, -1)], terminals)
...
class IllegalSyntaxTestCase(unittest.TestCase):
    ...
    def test_illegal_terminal(self):
        ...
        tree = 257, (269, (270, (271, (277, (1, b'pass'))), (4, ''))), (4, ''
            ), (0, '')
        self.check_bad_tree(tree, 'non-string second item in terminal node')
        tree = 257, (269, (270, (271, (277, (1, 'pass', '0', 0))), (4, ''))), (
            4, ''), (0, '')
    ...
    def test_illegal_yield_1(self):
        tree = 257, (264, (285, (259, (1, 'def'), (1, 'f'), (260, (7, '('),
            (8, ')')), (11, ':'), (291, (4, ''), (5, ''), (264, (265, (266,
            (272, (275, (1, 'return'), (313, (292, (293, (294, (295, (297,
            (298, (299, (300, (301, (302, (303, (304, (305, (2, '1'))))))))
            )))))))))), (264, (265, (266, (272, (276, (1, 'yield'), (313, (
            292, (293, (294, (295, (297, (298, (299, (300, (301, (302, (303,
            (304, (305, (2, '1')))))))))))))))))), (4, ''))), (6, ''))))),
            (4, ''), (0, '')))
        self.check_bad_tree(tree, 'def f():\n  return 1\n  yield 1')

    def test_illegal_yield_2(self):
        tree = 257, (264, (265, (266, (278, (1, 'from'), (281, (1,
            '__future__')), (1, 'import'), (279, (1, 'generators')))), (4, ''))
            ), (264, (285, (259, (1, 'def'), (1, 'f'), (260, (7, '('), (8,
            ')')), (11, ':'), (291, (4, ''), (5, ''), (264, (265, (266, (
            272, (275, (1, 'return'), (313, (292, (293, (294, (295, (297, (
            298, (299, (300, (301, (302, (303, (304, (305, (2, '1')))))))))
            ))))))))), (264, (265, (266, (272, (276, (1, 'yield'), (313, (
            292, (293, (294, (295, (297, (298, (299, (300, (301, (302, (303,
    ...
    def test_a_comma_comma_c(self):
        tree = 258, (311, (290, (291, (292, (293, (295, (296, (297, (298, (
            299, (300, (301, (302, (303, (1, 'a')))))))))))))), (12, ','),
            (12, ','), (290, (291, (292, (293, (295, (296, (297, (298, (299,
            (300, (301, (302, (303, (1, 'c'))))))))))))))), (4, ''), (0, '')
        self.check_bad_tree(tree, 'a,,c')

    def test_illegal_operator(self):
        tree = 257, (264, (265, (266, (267, (312, (291, (292, (293, (294, (
            296, (297, (298, (299, (300, (301, (302, (303, (304, (1, 'a')))
            )))))))))))), (268, (37, '$=')), (312, (291, (292, (293, (294,
            (296, (297, (298, (299, (300, (301, (302, (303, (304, (1, 'b'))
            ))))))))))))))), (4, ''))), (0, '')
        self.check_bad_tree(tree, 'a $= b')

    def test_malformed_global(self):
        tree = 257, (264, (265, (266, (282, (1, 'foo'))), (4, ''))), (4, ''), (
            0, '')
        self.check_bad_tree(tree, 'malformed global ast')

    def test_missing_import_source(self):
        tree = 257, (268, (269, (270, (282, (284, (1, 'from'), (1, 'import'
            ), (287, (285, (1, 'fred')))))), (4, ''))), (4, ''), (0, '')
...
class STObjectTestCase(unittest.TestCase):
    ...
    def test_copy_pickle(self):
        sts = [parser.expr('2 + 3'), parser.suite('x = 2; y = x + 3'),
    ...
    def test_sizeof(self):
        ...
        def check_st_sizeof(st):
            self.check_sizeof(st, basesize + nodesize + sizeofchildren(st.
                totuple()))
