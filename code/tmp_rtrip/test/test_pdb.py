...
class PdbTestCase(unittest.TestCase):
    ...
    def run_pdb(self, script, commands):
        ...
        stdout = stderr = None
        with subprocess.Popen(cmd, stdout=subprocess.PIPE, stdin=subprocess
            .PIPE, stderr=subprocess.STDOUT) as proc:
    ...
    def _assert_find_function(self, file_content, func_name, expected):
        ...
        expected = None if not expected else (expected[0], support.TESTFN,
            expected[1])
    ...
    def test_issue7964(self):
        ...
        proc = subprocess.Popen(cmd, stdout=subprocess.PIPE, stdin=
    ...
    def test_issue13183(self):
        ...
        self.assertTrue(any('main.py(5)foo()->None' in l for l in stdout.
            splitlines()), 'Fail to step into the caller after a return')
