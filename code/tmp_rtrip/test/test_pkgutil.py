...
class PkgutilTests(unittest.TestCase):
    ...
    def test_walkpackages_filesys(self):
        ...
        f = open(os.path.join(pkg2_dir, 'test_walkpackages_filesys',
            '__init__.py'), 'wb')
        f.close()
        f = open(os.path.join(pkg2_dir, 'test_walkpackages_filesys',
            'mod.py'), 'wb')
        f.close()
        expected = ['sub', 'sub.test_walkpackages_filesys',
            'sub.test_walkpackages_filesys.mod',
            'test_walkpackages_filesys', 'test_walkpackages_filesys.sub',
    ...
    def test_walkpackages_zipfile(self):
        ...
        z.close()
        sys.path.insert(0, zip_file)
        expected = ['sub', 'sub.test_walkpackages_zipfile',
            'sub.test_walkpackages_zipfile.mod',
            'test_walkpackages_zipfile', 'test_walkpackages_zipfile.sub',
...
class PkgutilPEP302Tests(unittest.TestCase):
    ...
    class MyTestImporter(object):
        ...
        def find_spec(self, fullname, path=None, target=None):
            ...
            return spec_from_file_location(fullname, '<%s>' % loader.
                __class__.__name__, loader=loader,
...
"""
    ...
    def test_simple(self):
        ...
        self.assertEqual(sorted(foo.__path__), sorted([os.path.join(
            dirname_0, pkgname), os.path.join(dirname_1, pkgname)]))
    ...
    def test_iter_importers(self):
        ...
        try:
            ...
            for finder in importers:
                ...
                self.assertIsInstance(loader, importlib.machinery.
                    SourceFileLoader)
