...
class DummyPOP3Handler(asynchat.async_chat):
    ...
    def cmd_utf8(self, arg):
        self.push('+OK I know RFC6856' if self.enable_UTF8 else
            '-ERR What is UTF8?!')
    if SUPPORTS_SSL:
        ...
        def cmd_stls(self, arg):
            if self.tls_active is False:
                ...
                tls_sock = context.wrap_socket(self.socket, server_side=
...
class TestPOP3Class(TestCase):
    ...
    def test_list(self):
        self.assertEqual(self.client.list()[1:], ([b'1 1', b'2 2', b'3 3',
            b'4 4', b'5 5'], 25))
        self.assertTrue(self.client.list('1').endswith(b'OK 1 1'))

    def test_retr(self):
        expected = b'+OK 116 bytes', [b'From: postmaster@python.org',
            b'Content-Type: text/plain', b'MIME-Version: 1.0',
            b'Subject: Dummy', b'', b'line1', b'line2', b'line3'], 113
...
class TestPOP3_SSLClass(TestPOP3Class):
    ...
    def test_context(self):
        ...
        self.assertRaises(ValueError, poplib.POP3_SSL, self.server.host,
            self.server.port, keyfile=CERTFILE, certfile=CERTFILE, context=ctx)
        self.client.quit()
        self.client = poplib.POP3_SSL(self.server.host, self.server.port,
            context=ctx)
...
class TestTimeouts(TestCase):
    ...
    def setUp(self):
        ...
        self.thread = threading.Thread(target=self.server, args=(self.evt,
            self.sock))
