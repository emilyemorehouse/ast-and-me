...
class ReprTests(unittest.TestCase):
    ...
    def test_lambda(self):
        ...
        self.assertTrue(r.startswith(
            '<function ReprTests.test_lambda.<locals>.<lambda'), r)
    ...
    def test_cell(self):
        ...
        self.assertRegex(repr(x),
            '<cell at 0x[0-9A-Fa-f]+: int object at 0x[0-9A-Fa-f]+>')
...
class LongReprTest(unittest.TestCase):
    ...
    def _check_path_limitations(self, module_name):
        ...
        cached_path_len = source_path_len + len(importlib.util.
            cache_from_source('x.py')) - len('x.py')
    ...
    def test_module(self):
        ...
        self.assertEqual(repr(module), '<module %r from %r>' % (module.
            __name__, module.__file__))
    ...
    def test_instance(self):
        ...
        ibaz = baz.baz()
        self.assertTrue(repr(ibaz).startswith('<%s.baz object at 0x' % baz.
            __name__))
