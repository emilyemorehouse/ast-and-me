...
class Compare_Digest_Tests(unittest.TestCase):
    ...
    def test_equal(self):
        for s in ('a', 'bcd', 'xyz123'):
            ...
            self.assertTrue(secrets.compare_digest(a.encode('utf-8'), b.
                encode('utf-8')))
    ...
    def test_unequal(self):
        ...
        for s in ('x', 'mn', 'a1b2c3'):
            ...
            self.assertFalse(secrets.compare_digest(a.encode('utf-8'), b.
                encode('utf-8')))
...
class Token_Tests(unittest.TestCase):
    ...
    def test_token_defaults(self):
        for func in (secrets.token_bytes, secrets.token_hex, secrets.
            token_urlsafe):
