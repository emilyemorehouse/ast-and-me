...
class BaseSelectorTestCase(unittest.TestCase):
    ...
    def test_register(self):
        ...
        self.assertRaises(KeyError, s.register, rd.fileno(), selectors.
            EVENT_READ)
    ...
    def test_select(self):
        ...
        for key, events in result:
            ...
            self.assertFalse(events & ~(selectors.EVENT_READ | selectors.
                EVENT_WRITE))
...
def test_main():
    tests = [DefaultSelectorTestCase, SelectSelectorTestCase,
        PollSelectorTestCase, EpollSelectorTestCase, KqueueSelectorTestCase,
