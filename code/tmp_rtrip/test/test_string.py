...
class ModuleTest(unittest.TestCase):
    ...
    def test_attrs(self):
        ...
        self.assertEqual(string.ascii_letters, string.ascii_lowercase +
        ...
        self.assertEqual(string.punctuation,
            '!"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~')
        self.assertEqual(string.printable, string.digits + string.
            ascii_lowercase + string.ascii_uppercase + string.punctuation +
            string.whitespace)
    ...
    def test_format_keyword_arguments(self):
        ...
        self.assertEqual(fmt.format('-{format_string}-', format_string=
            'test'), '-test-')
    ...
    def test_auto_numbering(self):
        fmt = string.Formatter()
        self.assertEqual(fmt.format('foo{}{}', 'bar', 6), 'foo{}{}'.format(
            'bar', 6))
        self.assertEqual(fmt.format('foo{1}{num}{1}', None, 'bar', num=6),
            'foo{1}{num}{1}'.format(None, 'bar', num=6))
        self.assertEqual(fmt.format('{:^{}}', 'bar', 6), '{:^{}}'.format(
            'bar', 6))
    ...
    def test_check_unused_args(self):
        ...
        self.assertRaises(ValueError, fmt.format, '{0}{i}{1}', 10, 20, i=
            100, j=0)
...
class TestTemplate(unittest.TestCase):
    ...
    def test_keyword_arguments(self):
        ...
        eq(s.substitute(dict(who='fred', what='kung pao'), who='tim', what=
            'ham'), 'tim likes ham')
    ...
    def test_keyword_arguments_safe(self):
        ...
        eq(s.safe_substitute(dict(who='fred', what='kung pao'), who='tim',
            what='ham'), 'tim likes ham')
        s = Template('the mapping is $mapping')
