...
class TestSupport(unittest.TestCase):
    ...
    def test_sortdict(self):
        self.assertEqual(support.sortdict({(3): 3, (2): 2, (1): 1}),
            '{1: 1, 2: 2, 3: 3}')
    ...
    def test_detect_api_mismatch(self):
        missing_items = support.detect_api_mismatch(self.RefClass, self.
            OtherClass)
        self.assertEqual({'attribute1'}, missing_items)
        missing_items = support.detect_api_mismatch(self.OtherClass, self.
            RefClass)
    ...
    def test_detect_api_mismatch__ignore(self):
        ...
        missing_items = support.detect_api_mismatch(self.RefClass, self.
            OtherClass, ignore=ignore)
        self.assertEqual(set(), missing_items)
        missing_items = support.detect_api_mismatch(self.OtherClass, self.
            RefClass, ignore=ignore)
        self.assertEqual(set(), missing_items)
    ...
    def test_check__all__(self):
        ...
        support.check__all__(self, unittest, ('unittest.result',
            'unittest.case', 'unittest.suite', 'unittest.loader',
            'unittest.main', 'unittest.runner', 'unittest.signals'), extra=
            extra, blacklist=blacklist)
