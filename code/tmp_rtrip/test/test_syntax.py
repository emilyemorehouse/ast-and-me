...
class SyntaxTestCase(unittest.TestCase):
    ...
    def _check_error(self, code, errtext, filename='<testcase>', mode=
        'exec', subclass=None, lineno=None, offset=None):
    ...
    def test_bad_outdent(self):
        self._check_error('if 1:\n  foo()\n bar()',
            'unindent does not match .* level', subclass=IndentationError)
