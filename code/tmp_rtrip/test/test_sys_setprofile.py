...
class ProfileSimulator(HookWatcher):
    ...
    def trace_pass(self, frame):
        pass
    dispatch = {'call': trace_call, 'exception': trace_exception, 'return':
        trace_return, 'c_call': trace_pass, 'c_return': trace_pass,
...
class ProfileHookTestCase(TestCaseBase):
    ...
    def test_exception_in_except_clause(self):
        ...
        f_ident = ident(f)
        g_ident = ident(g)
        self.check_events(g, [(1, 'call', g_ident), (2, 'call', f_ident), (
            2, 'return', f_ident), (3, 'call', f_ident), (3, 'return',
            f_ident), (1, 'return', g_ident)])
    ...
    def test_exception_propagation(self):
        ...
        g_ident = ident(g)
        self.check_events(g, [(1, 'call', g_ident), (2, 'call', f_ident), (
            2, 'return', f_ident), (1, 'falling through', g_ident), (1,
            'return', g_ident)])
    ...
    def test_distant_exception(self):
        ...
        i_ident = ident(i)
        j_ident = ident(j)
        self.check_events(j, [(1, 'call', j_ident), (2, 'call', i_ident), (
            3, 'call', h_ident), (4, 'call', g_ident), (5, 'call', f_ident),
            (5, 'return', f_ident), (4, 'return', g_ident), (3, 'return',
            h_ident), (2, 'return', i_ident), (1, 'return', j_ident)])
    ...
    def test_generator(self):
        ...
        g_ident = ident(g)
        self.check_events(g, [(1, 'call', g_ident), (2, 'call', f_ident), (
            2, 'return', f_ident), (2, 'call', f_ident), (2, 'return',
            f_ident), (2, 'call', f_ident), (2, 'return', f_ident), (1,
            'return', g_ident)])
