...
arigo_example.events = [(0, 'call'), (1, 'line'), (2, 'line'), (5, 'line'),
    (5, 'return')]
...
one_instr_line.events = [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'),
    (3, 'return')]
...
no_pop_tops.events = [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (
    6, 'line'), (2, 'line'), (3, 'line'), (4, 'line'), (2, 'line'), (2,
    'return')]
...
no_pop_blocks.events = [(0, 'call'), (1, 'line'), (2, 'line'), (4, 'line'),
    (4, 'return')]
...
call.events = [(0, 'call'), (1, 'line'), (-3, 'call'), (-2, 'line'), (-2,
    'return'), (1, 'return')]
...
test_raise.events = [(0, 'call'), (1, 'line'), (2, 'line'), (-3, 'call'), (
    -2, 'line'), (-2, 'exception'), (-2, 'return'), (2, 'exception'), (3,
    'line'), (4, 'line'), (4, 'return')]
...
settrace_and_raise.events = [(2, 'exception'), (3, 'line'), (4, 'line'), (4,
    'return')]
...
ireturn_example.events = [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'
    ), (4, 'line'), (6, 'line'), (6, 'return')]
...
tightloop_example.events = [(0, 'call'), (1, 'line'), (2, 'line'), (3,
    'line'), (4, 'line'), (5, 'line'), (5, 'line'), (5, 'line'), (5, 'line'
    ), (5, 'exception'), (6, 'line'), (7, 'line'), (7, 'return')]
...
tighterloop_example.events = [(0, 'call'), (1, 'line'), (2, 'line'), (3,
    'line'), (4, 'line'), (4, 'line'), (4, 'line'), (4, 'line'), (4,
    'exception'), (5, 'line'), (6, 'line'), (6, 'return')]
...
generator_example.events = [(0, 'call'), (2, 'line'), (-6, 'call'), (-5,
    'line'), (-4, 'line'), (-4, 'return'), (-4, 'call'), (-4, 'exception'),
    (-1, 'line'), (-1, 'return')] + [(5, 'line'), (6, 'line')] * 10 + [(5,
    'line'), (5, 'return')]
...
class TraceTestCase(unittest.TestCase):
    ...
    def compare_events(self, line_offset, events, expected_events):
        ...
        if events != expected_events:
            self.fail('events did not match expectation:\n' + '\n'.join(
                difflib.ndiff([str(x) for x in expected_events], [str(x) for
                x in events])))
    ...
    def run_test2(self, func):
        ...
        func(tracer.trace)
        sys.settrace(None)
        self.compare_events(func.__code__.co_firstlineno, tracer.events,
            func.events)
    ...
    def test_14_onliner_if(self):
        ...
        def onliners():
            if True:
                ...
                x = True
            return 0
        self.run_and_compare(onliners, [(0, 'call'), (1, 'line'), (3,
            'line'), (3, 'return')])
    ...
    def test_15_loops(self):
        ...
        def for_example():
            for x in range(2):
                pass
        self.run_and_compare(for_example, [(0, 'call'), (1, 'line'), (2,
            'line'), (1, 'line'), (2, 'line'), (1, 'line'), (1, 'return')])

        def while_example():
            x = 2
            while x > 0:
                x -= 1
        self.run_and_compare(while_example, [(0, 'call'), (2, 'line'), (3,
            'line'), (4, 'line'), (3, 'line'), (4, 'line'), (3, 'line'), (3,
            'return')])

    def test_16_blank_lines(self):
        namespace = {}
        exec('def f():\n' + '\n' * 256 + '    pass', namespace)
        self.run_and_compare(namespace['f'], [(0, 'call'), (257, 'line'), (
            257, 'return')])
...
class RaisingTraceFuncTestCase(unittest.TestCase):
    ...
    def test_trash_stack(self):
        ...
        def g(frame, why, extra):
            if (why == 'line' and frame.f_lineno == f.__code__.
                co_firstlineno + 2):
...
def test_main():
    support.run_unittest(TraceTestCase, RaisingTraceFuncTestCase, JumpTestCase)
