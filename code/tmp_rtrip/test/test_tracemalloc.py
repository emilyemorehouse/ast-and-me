...
def create_snapshots():
    traceback_limit = 2
    raw_traces = [(0, 10, (('a.py', 2), ('b.py', 4))), (0, 10, (('a.py', 2),
        ('b.py', 4))), (0, 10, (('a.py', 2), ('b.py', 4))), (1, 2, (('a.py',
        5), ('b.py', 4))), (2, 66, (('b.py', 1),)), (3, 7, (('<unknown>', 0),))
        ]
    snapshot = tracemalloc.Snapshot(raw_traces, traceback_limit)
    raw_traces2 = [(0, 10, (('a.py', 2), ('b.py', 4))), (0, 10, (('a.py', 2
        ), ('b.py', 4))), (0, 10, (('a.py', 2), ('b.py', 4))), (2, 2, ((
        'a.py', 5), ('b.py', 4))), (2, 5000, (('a.py', 5), ('b.py', 4))), (
        4, 400, (('c.py', 578),))]
...
class TestSnapshot(unittest.TestCase):
    ...
    def test_create_snapshot(self):
        ...
        with contextlib.ExitStack() as stack:
            ...
            stack.enter_context(patch.object(tracemalloc,
                'get_traceback_limit', return_value=5))
    ...
    def test_filter_traces(self):
        ...
        self.assertEqual(snapshot3.traces._traces, [(0, 10, (('a.py', 2), (
            'b.py', 4))), (0, 10, (('a.py', 2), ('b.py', 4))), (0, 10, ((
            'a.py', 2), ('b.py', 4))), (1, 2, (('a.py', 5), ('b.py', 4))),
            (3, 7, (('<unknown>', 0),))])
        self.assertEqual(snapshot.traces._traces, original_traces)
        snapshot4 = snapshot3.filter_traces((filter2, filter3))
        self.assertEqual(snapshot4.traces._traces, [(0, 10, (('a.py', 2), (
            'b.py', 4))), (0, 10, (('a.py', 2), ('b.py', 4))), (0, 10, ((
            'a.py', 2), ('b.py', 4))), (1, 2, (('a.py', 5), ('b.py', 4)))])
    ...
    def test_filter_traces_domain_filter(self):
        ...
        self.assertEqual(snapshot3.traces._traces, [(3, 7, (('<unknown>', 0
            ),))])
    ...
    def test_snapshot_group_by_line(self):
        ...
        self.assertEqual(stats1, [tracemalloc.Statistic(tb_b_1, 66, 1),
            tracemalloc.Statistic(tb_a_2, 30, 3), tracemalloc.Statistic(
            tb_0, 7, 1), tracemalloc.Statistic(tb_a_5, 2, 1)])
        stats2 = snapshot2.statistics('lineno')
        self.assertEqual(stats2, [tracemalloc.Statistic(tb_a_5, 5002, 2),
            tracemalloc.Statistic(tb_c_578, 400, 1), tracemalloc.Statistic(
            tb_a_2, 30, 3)])
        statistics = snapshot2.compare_to(snapshot, 'lineno')
        self.assertEqual(statistics, [tracemalloc.StatisticDiff(tb_a_5, 
            5002, 5000, 2, 1), tracemalloc.StatisticDiff(tb_c_578, 400, 400,
            1, 1), tracemalloc.StatisticDiff(tb_b_1, 0, -66, 0, -1),
            tracemalloc.StatisticDiff(tb_0, 0, -7, 0, -1), tracemalloc.
            StatisticDiff(tb_a_2, 30, 0, 3, 0)])
    ...
    def test_snapshot_group_by_file(self):
        ...
        self.assertEqual(stats1, [tracemalloc.Statistic(tb_b, 66, 1),
            tracemalloc.Statistic(tb_a, 32, 4), tracemalloc.Statistic(tb_0,
            7, 1)])
        stats2 = snapshot2.statistics('filename')
        self.assertEqual(stats2, [tracemalloc.Statistic(tb_a, 5032, 5),
            tracemalloc.Statistic(tb_c, 400, 1)])
        diff = snapshot2.compare_to(snapshot, 'filename')
        self.assertEqual(diff, [tracemalloc.StatisticDiff(tb_a, 5032, 5000,
            5, 1), tracemalloc.StatisticDiff(tb_c, 400, 400, 1, 1),
            tracemalloc.StatisticDiff(tb_b, 0, -66, 0, -1), tracemalloc.
            StatisticDiff(tb_0, 0, -7, 0, -1)])
    ...
    def test_snapshot_group_by_traceback(self):
        ...
        self.assertEqual(stats1, [tracemalloc.Statistic(tb3, 66, 1),
            tracemalloc.Statistic(tb1, 30, 3), tracemalloc.Statistic(tb4, 7,
            1), tracemalloc.Statistic(tb2, 2, 1)])
        tb5 = traceback(('c.py', 578))
        stats2 = snapshot2.statistics('traceback')
        self.assertEqual(stats2, [tracemalloc.Statistic(tb2, 5002, 2),
            tracemalloc.Statistic(tb5, 400, 1), tracemalloc.Statistic(tb1, 
            30, 3)])
        diff = snapshot2.compare_to(snapshot, 'traceback')
        self.assertEqual(diff, [tracemalloc.StatisticDiff(tb2, 5002, 5000, 
            2, 1), tracemalloc.StatisticDiff(tb5, 400, 400, 1, 1),
            tracemalloc.StatisticDiff(tb3, 0, -66, 0, -1), tracemalloc.
            StatisticDiff(tb4, 0, -7, 0, -1), tracemalloc.StatisticDiff(tb1,
            30, 0, 3, 0)])
        self.assertRaises(ValueError, snapshot.statistics, 'traceback',
            cumulative=True)
    ...
    def test_snapshot_group_by_cumulative(self):
        ...
        self.assertEqual(stats, [tracemalloc.Statistic(tb_b, 98, 5),
            tracemalloc.Statistic(tb_a, 32, 4), tracemalloc.Statistic(tb_0,
            7, 1)])
        stats = snapshot.statistics('lineno', True)
        self.assertEqual(stats, [tracemalloc.Statistic(tb_b_1, 66, 1),
            tracemalloc.Statistic(tb_b_4, 32, 4), tracemalloc.Statistic(
            tb_a_2, 30, 3), tracemalloc.Statistic(tb_0, 7, 1), tracemalloc.
            Statistic(tb_a_5, 2, 1)])
    ...
    def test_slices(self):
        snapshot, snapshot2 = create_snapshots()
        self.assertEqual(snapshot.traces[:2], (snapshot.traces[0], snapshot
            .traces[1]))
    ...
    def test_format_traceback(self):
        ...
        with unittest.mock.patch('tracemalloc.linecache.getline',
            ...
            self.assertEqual(tb.format(), ['  File "a.py", line 2',
                '    <a.py, 2>', '  File "b.py", line 4', '    <b.py, 4>'])
            self.assertEqual(tb.format(limit=1), ['  File "a.py", line 2',
                '    <a.py, 2>'])
...
class TestFilters(unittest.TestCase):
    ...
    def test_filter_attributes(self):
        ...
        f = tracemalloc.Filter(inclusive=False, filename_pattern='test.py',
            lineno=123, all_frames=True)
        self.assertEqual(f.inclusive, False)
        self.assertEqual(f.filename_pattern, 'test.py')
        self.assertEqual(f.lineno, 123)
        self.assertEqual(f.all_frames, True)
...
class TestCommandLine(unittest.TestCase):
    ...
    def test_env_var_ignored_with_E(self):
        ...
        code = 'import tracemalloc; print(tracemalloc.is_tracing())'
        ok, stdout, stderr = assert_python_ok('-E', '-c', code,
            PYTHONTRACEMALLOC='1')
        stdout = stdout.rstrip()
        self.assertEqual(stdout, b'False')
    ...
    def test_env_limit(self):
        ...
        ok, stdout, stderr = assert_python_ok('-c', code, PYTHONTRACEMALLOC
            ='10')
        stdout = stdout.rstrip()
        ...
        for nframe in (-1, 0, 2 ** 30):
            with self.subTest(nframe=nframe):
                with support.SuppressCrashReport():
                    ok, stdout, stderr = assert_python_failure('-c', 'pass',
                        PYTHONTRACEMALLOC=str(nframe))
                    self.assertIn(
                        b'PYTHONTRACEMALLOC: invalid number of frames', stderr)

    def test_sys_xoptions(self):
        for xoptions, nframe in (('tracemalloc', 1), ('tracemalloc=1', 1),
            ('tracemalloc=15', 15)):
            with self.subTest(xoptions=xoptions, nframe=nframe):
                code = (
                    'import tracemalloc; print(tracemalloc.get_traceback_limit())'
                    )
                ok, stdout, stderr = assert_python_ok('-X', xoptions, '-c',
                    code)
                stdout = stdout.rstrip()
        ...
        for nframe in (-1, 0, 2 ** 30):
            with self.subTest(nframe=nframe):
                with support.SuppressCrashReport():
                    ...
                    self.assertIn(
                        b'-X tracemalloc=NFRAME: invalid number of frames',
                        stderr)
...
def test_main():
    support.run_unittest(TestTracemallocEnabled, TestSnapshot, TestFilters,
        TestCommandLine, TestCAPI)
