        ...
        for module in ('request', 'response', 'parse', 'error', 'robotparser'):
            ...
            for k, v in context.items():
                self.assertEqual(v.__module__, 'urllib.%s' % module, 
                    "%r is exposed in 'urllib.%s' but defined in %r" % (k,
                    module, v.__module__))
...
class RequestHdrsTests(unittest.TestCase):
    ...
    def test_request_headers_dict(self):
        ...
        self.assertEqual(Request(url, headers={'Spam-eggs': 'blah'}).
    ...
    def test_request_headers_methods(self):
        ...
        self.assertEqual(sorted(req.header_items()), [('Foo-bar', 'baz'), (
            'Spam-eggs', 'blah')])
    ...
    def test_password_manager(self):
        ...
        self.assertEqual(find_user_pass('Some Realm',
            'http://example.com/ni'), ('joe', 'password'))
        self.assertEqual(find_user_pass('Some Realm', 'http://example.com'),
            ('joe', 'password'))
        self.assertEqual(find_user_pass('Some Realm', 'http://example.com/'
            ), ('joe', 'password'))
        self.assertEqual(find_user_pass('Some Realm',
            'http://example.com/spam'), ('joe', 'password'))
        self.assertEqual(find_user_pass('Some Realm',
            'http://example.com/spam/spam'), ('joe', 'password'))
    ...
    def test_password_manager_default_port(self):
        ...
        self.assertEqual(find_user_pass('f', 'http://g.example.com:80'), (
            '10', 'j'))
        self.assertEqual(find_user_pass('f', 'http://g.example.com'), ('10',
            'j'))
        ...
        self.assertEqual(find_user_pass('i', 'http://j.example.com'), ('13',
            'm'))
...
class MockHTTPHandler(urllib.request.BaseHandler):
    ...
    def http_open(self, req):
        ...
        if self._count == 0:
            ...
            return self.parent.error('http', req, MockFile(), self.code,
                name, msg)
        else:
            self.req = req
...
class OpenerDirectorTests(unittest.TestCase):
    ...
    def test_badly_named_methods(self):
        ...
        o = OpenerDirector()
        meth_spec = [[('do_open', 'return self'), ('proxy_open',
            'return self')], [('redirect_request', 'return self')]]
    ...
    def test_handled(self):
        ...
        meth_spec = [['http_open', 'ftp_open', 'http_error_302'], [
            'ftp_open'], [('http_open', 'return self')], [('http_open',
            'return self')]]
    ...
    def test_http_error(self):
        o = OpenerDirector()
        meth_spec = [[('http_open', 'error 302')], [('http_error_400',
            'raise'), 'http_open'], [('http_error_302', 'return response'),
            'http_error_303', 'http_error'], ['http_error_302']]
        handlers = add_ordered_mock_handlers(o, meth_spec)
        ...
        calls = [(handlers[0], 'http_open', (req,)), (handlers[2],
            'http_error_302', (req, Unknown(), 302, '', {}))]
        for expected, got in zip(calls, o.calls):
    ...
    def test_processors(self):
        o = OpenerDirector()
        meth_spec = [[('http_request', 'return request'), ('http_response',
            'return response')], [('http_request', 'return request'), (
            'http_response', 'return response')]]
        handlers = add_ordered_mock_handlers(o, meth_spec)
        req = Request('http://example.com/')
        o.open(req)
        calls = [(handlers[0], 'http_request'), (handlers[1],
            'http_request'), (handlers[0], 'http_response'), (handlers[1],
            'http_response')]
...
class HandlerTests(unittest.TestCase):
    ...
    def test_ftp(self):
        ...
        for url, host, port, user, passwd, type_, dirs, filename, mimetype in [
            ('ftp://localhost/foo/bar/baz.html', 'localhost', ftplib.
            FTP_PORT, '', '', 'I', ['foo', 'bar'], 'baz.html', 'text/html'),
            ('ftp://parrot@localhost/foo/bar/baz.html', 'localhost', ftplib
            .FTP_PORT, 'parrot', '', 'I', ['foo', 'bar'], 'baz.html',
            'text/html'), ('ftp://%25parrot@localhost/foo/bar/baz.html',
            'localhost', ftplib.FTP_PORT, '%parrot', '', 'I', ['foo', 'bar'
            ], 'baz.html', 'text/html'), (
            'ftp://%2542parrot@localhost/foo/bar/baz.html', 'localhost',
            ftplib.FTP_PORT, '%42parrot', '', 'I', ['foo', 'bar'],
            'baz.html', 'text/html'), ('ftp://localhost:80/foo/bar/',
            'localhost', 80, '', '', 'D', ['foo', 'bar'], '', None), (
    ...
    def test_file(self):
        ...
        for url in ['file://localhost:80%s' % urlpath,
            ...
            'file://%s:80%s/%s' % (socket.gethostbyname('localhost'), os.
            getcwd(), TESTFN), 
            'file://somerandomhost.ontheinternet.com%s/%s' % (os.getcwd(),
            TESTFN)]:
            try:
                f = open(TESTFN, 'wb')
                try:
        ...
        h = urllib.request.FileHandler()
        o = h.parent = MockOpener()
        for url, ftp in [('file://ftp.example.com//foo.txt', False), (
    ...
    def test_http(self):
        ...
        for method, data in [('GET', None), ('POST', b'blah')]:
            ...
            self.assertEqual(http.req_headers, [('Connection', 'close'), (
                'Foo', 'bar'), ('Spam', 'eggs')])
    ...
    def test_full_url_setter(self):
        urls = ['http://example.com?foo=bar#baz',
            'http://example.com?foo=bar&spam=eggs#bash', 'http://example.com']
    ...
    def test_redirect(self):
        ...
        for code in (301, 302, 303, 307):
            for data in (None, 'blah\nblah\n'):
                ...
                try:
                    method(req, MockFile(), code, 'Blah', MockHeaders({
                        'location': to_url}))
        ...
        def redirect(h, req, url=to_url):
            h.http_error_302(req, MockFile(), 302, 'Blah', MockHeaders({
                'location': url}))
        ...
        try:
            ...
            self.assertEqual(count, urllib.request.HTTPRedirectHandler.
                max_repeats)
        req = Request(from_url, origin_req_host='example.com')
        count = 0
        req.timeout = socket._GLOBAL_DEFAULT_TIMEOUT
    ...
    def test_invalid_redirect(self):
        ...
        for scheme in invalid_schemes:
            ...
            self.assertRaises(urllib.error.HTTPError, h.http_error_302, req,
                MockFile(), 302, 'Security Loophole', MockHeaders({
    ...
    def test_relative_redirect(self):
        ...
        h.http_error_302(req, MockFile(), 302, "That's fine", MockHeaders({
            'location': valid_url}))
        self.assertEqual(o.req.get_full_url(), valid_url)
    ...
    def test_redirect_encoding(self):
        ...
        tests = (b'/p\xc3\xa5-dansk/', b'/p%C3%A5-dansk/'), (b'/spaced%20path/'
            , b'/spaced%20path/'), (b'/spaced path/', b'/spaced%20path/'), (
    ...
    def test_proxy(self):
        ...
        self.assertEqual([(handlers[0], 'http_open')], [tup[0:2] for tup in
            o.calls])
    ...
    def test_proxy_https(self):
        ...
        o.open(req)
        self.assertEqual(req.host, 'proxy.example.com:3128')
        self.assertEqual([(handlers[0], 'https_open')], [tup[0:2] for tup in
            o.calls])
    ...
    def test_proxy_https_proxy_authorization(self):
        ...
        o.open(req)
        self.assertNotIn(('Proxy-Authorization', 'FooBar'), https_handler.
            httpconn.req_headers)
        self.assertIn(('User-Agent', 'Grail'), https_handler.httpconn.
            req_headers)
    ...
    def test_osx_proxy_bypass(self):
        bypass = {'exclude_simple': False, 'exceptions': ['foo.bar',
            '*.bar.com', '127.0.0.1', '10.10', '10.0/16']}
    ...
    def test_basic_auth(self, quote_char='"'):
        ...
        http_handler = MockHTTPHandler(401, 
            'WWW-Authenticate: Basic realm=%s%s%s\r\n\r\n' % (quote_char,
            realm, quote_char))
        opener.add_handler(auth_handler)
        opener.add_handler(http_handler)
        self._test_basic_auth(opener, auth_handler, 'Authorization', realm,
            http_handler, password_manager,
    ...
    def test_proxy_basic_auth(self):
        ...
        realm = 'ACME Networks'
        http_handler = MockHTTPHandler(407, 
            'Proxy-Authenticate: Basic realm="%s"\r\n\r\n' % realm)
        opener.add_handler(auth_handler)
        opener.add_handler(http_handler)
        self._test_basic_auth(opener, auth_handler, 'Proxy-authorization',
            realm, http_handler, password_manager,
            'http://acme.example.com:3128/protected', 'proxy.example.com:3128')
    ...
    def test_basic_and_digest_auth_handlers(self):
        ...
        opener.add_handler(http_handler)
        self._test_basic_auth(opener, basic_handler, 'Authorization', realm,
            http_handler, password_manager,
            'http://acme.example.com/protected',
            'http://acme.example.com/protected')
    ...
    def _test_basic_auth(self, opener, auth_handler, auth_header, realm,
        http_handler, password_manager, request_url, protected_url):
        import base64
        ...
        auth_hdr_value = 'Basic ' + base64.encodebytes(userpass).strip(
            ).decode()
        self.assertEqual(http_handler.requests[1].get_header(auth_header),
            auth_hdr_value)
        self.assertEqual(http_handler.requests[1].unredirected_hdrs[
            auth_header], auth_hdr_value)
    ...
    def test_basic_prior_auth_auto_send(self):
        ...
        auth_prior_handler.add_password(None, request_url, user, password,
    ...
    def test_http_closed(self):
        ...
        for transfer, data in (('Connection: close', b'data'), (
...
class MiscTests(unittest.TestCase):
    ...
    def opener_has_handler(self, opener, handler_class):
        self.assertTrue(any(h.__class__ == handler_class for h in opener.
            handlers))
    ...
    def test_parse_proxy(self):
        parse_proxy_test_cases = [('proxy.example.com', (None, None, None,
            'proxy.example.com')), ('proxy.example.com:3128', (None, None,
            None, 'proxy.example.com:3128')), ('proxy.example.com', (None,
            None, None, 'proxy.example.com')), ('proxy.example.com:3128', (
            None, None, None, 'proxy.example.com:3128')), (
            'joe:password@proxy.example.com', (None, 'joe', 'password',
            'proxy.example.com')), ('joe:password@proxy.example.com:3128',
            (None, 'joe', 'password', 'proxy.example.com:3128')), (
            'http://proxy.example.com/', ('http', None, None,
            'proxy.example.com')), ('http://proxy.example.com:3128/', (
            'http', None, None, 'proxy.example.com:3128')), (
            'http://joe:password@proxy.example.com/', ('http', 'joe',
            'password', 'proxy.example.com')), (
            'http://joe:password@proxy.example.com:3128', ('http', 'joe',
            'password', 'proxy.example.com:3128')), (
            'ftp://joe:password@proxy.example.com/rubbish:3128', ('ftp',
...
class RequestTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.post = Request('http://www.python.org/~jeremy/', 'data',
            headers={'X-Test': 'test'})
    ...
    def test_get_full_url(self):
        self.assertEqual('http://www.python.org/~jeremy/', self.get.
            get_full_url())
