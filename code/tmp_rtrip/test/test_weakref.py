...
class MappingTestCase(TestBase):
    ...
    def test_weak_valued_dict_popitem(self):
        self.check_popitem(weakref.WeakValueDictionary, 'key1', C(), 'key2',
            C())

    def test_weak_keyed_dict_popitem(self):
        self.check_popitem(weakref.WeakKeyDictionary, C(), 'value 1', C(),
            'value 2')
    ...
    def test_weak_keyed_dict_setdefault(self):
        self.check_setdefault(weakref.WeakKeyDictionary, C(), 'value 1',
            'value 2')
    ...
    def test_weak_valued_dict_update(self):
        self.check_update(weakref.WeakValueDictionary, {(1): C(), 'a': C(),
            C(): C()})
...
def test_main():
    support.run_unittest(ReferencesTestCase, WeakMethodTestCase,
        ...
        WeakKeyDictionaryTestCase, SubclassableWeakrefTestCase,
        FinalizeTestCase)
