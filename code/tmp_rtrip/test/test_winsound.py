...
class PlaySoundTest(unittest.TestCase):
    ...
    def test_errors(self):
        ...
        self.assertRaises(RuntimeError, winsound.PlaySound, 'none', 
            winsound.SND_ASYNC | winsound.SND_MEMORY)
        self.assertRaises(TypeError, winsound.PlaySound, b'bad', 0)
        self.assertRaises(TypeError, winsound.PlaySound, 'bad', winsound.
            SND_MEMORY)
    ...
    def test_snd_memory(self):
        with open(support.findfile('pluck-pcm8.wav', subdir='audiodata'), 'rb'
            ) as f:
            audio_data = f.read()
    ...
    def test_aliases(self):
        aliases = ['SystemAsterisk', 'SystemExclamation', 'SystemExit',
            'SystemHand', 'SystemQuestion']
    ...
    def test_alias_nofallback(self):
        safe_PlaySound('!"$%&/(#+*', winsound.SND_ALIAS | winsound.
            SND_NODEFAULT)

    def test_stopasync(self):
        safe_PlaySound('SystemQuestion', winsound.SND_ALIAS | winsound.
            SND_ASYNC | winsound.SND_LOOP)
        time.sleep(0.5)
        safe_PlaySound('SystemQuestion', winsound.SND_ALIAS | winsound.
            SND_NOSTOP)
