...
def hello_app(environ, start_response):
    start_response('200 OK', [('Content-Type', 'text/plain'), ('Date',
        'Mon, 05 Jun 2006 18:49:54 GMT')])
...
def header_app(environ, start_response):
    start_response('200 OK', [('Content-Type', 'text/plain'), ('Date',
        'Mon, 05 Jun 2006 18:49:54 GMT')])
    return [';'.join([environ['HTTP_X_TEST_HEADER'], environ['QUERY_STRING'
        ], environ['PATH_INFO']]).encode('iso-8859-1')]
...
class IntegrationTests(TestCase):
    ...
    def test_cp1252_url(self):
        ...
        def app(e, s):
            s('200 OK', [('Content-Type', 'text/plain'), ('Date',
                'Wed, 24 Dec 2008 13:29:32 GMT')])
            return [e['PATH_INFO'].encode('latin1')]
        out, err = run_amock(validator(app), data=b'GET /\x80%80 HTTP/1.0')
        self.assertEqual([b'HTTP/1.0 200 OK', mock.ANY,
            b'Content-Type: text/plain',
            b'Date: Wed, 24 Dec 2008 13:29:32 GMT', b'', b'/\x80\x80'], out
            .splitlines())
...
class UtilityTests(TestCase):
    ...
    def testDefaults(self):
        for key, value in [('SERVER_NAME', '127.0.0.1'), ('SERVER_PORT',
            '80'), ('SERVER_PROTOCOL', 'HTTP/1.0'), ('HTTP_HOST',
            '127.0.0.1'), ('REQUEST_METHOD', 'GET'), ('SCRIPT_NAME', ''), (
            'PATH_INFO', '/'), ('wsgi.version', (1, 0)), ('wsgi.run_once', 
            0), ('wsgi.multithread', 0), ('wsgi.multiprocess', 0), (
            'wsgi.input', BytesIO()), ('wsgi.errors', StringIO()), (
    ...
    def testAppURIs(self):
        ...
        self.checkAppURI('http://spam.example.com:2071/', HTTP_HOST=
            'spam.example.com:2071', SERVER_PORT='2071')
        self.checkAppURI('http://spam.example.com/', SERVER_NAME=
            'spam.example.com')
        self.checkAppURI('http://127.0.0.1/', HTTP_HOST='127.0.0.1',
    ...
    def testReqURIs(self):
        ...
        self.checkReqURI('http://127.0.0.1/spammity/spam', SCRIPT_NAME=
            '/spammity', PATH_INFO='/spam')
        self.checkReqURI('http://127.0.0.1/spammity/sp%E4m', SCRIPT_NAME=
            '/spammity', PATH_INFO='/späm')
        self.checkReqURI('http://127.0.0.1/spammity/spam;ham', SCRIPT_NAME=
            '/spammity', PATH_INFO='/spam;ham')
        ...
        self.checkReqURI('http://127.0.0.1/spammity/spam', 0, SCRIPT_NAME=
            '/spammity', PATH_INFO='/spam', QUERY_STRING='say=ni')
...
class ErrorHandler(BaseCGIHandler):
    ...
    def __init__(self, **kw):
        ...
        BaseCGIHandler.__init__(self, BytesIO(), BytesIO(), StringIO(), kw,
    ...
    def checkEnvironAttrs(self, handler):
        ...
        for attr in ['version', 'multithread', 'multiprocess', 'run_once',
            ...
            if attr == 'file_wrapper' and handler.wsgi_file_wrapper is None:
                continue
            self.assertEqual(getattr(handler, 'wsgi_' + attr), env['wsgi.' +
                attr])
            ...
            for version in ('1.0', '1.1'):
                for proto in ('HTTP/0.9', 'HTTP/1.0', 'HTTP/1.1'):
                    ...
                    if proto == 'HTTP/0.9':
                        ...
                        self.assertTrue(re.match((stdpat % (version, sw)).
                            encode('iso-8859-1'), h.stdout.getvalue()), ((
                            stdpat % (version, sw)).encode('iso-8859-1'), h
                            .stdout.getvalue()))
