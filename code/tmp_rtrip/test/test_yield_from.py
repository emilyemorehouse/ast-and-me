...
class TestPEP380Operation(unittest.TestCase):
    ...
    def test_delegation_of_initial_next_to_subgenerator(self):
        ...
        self.assertEqual(trace, ['Starting g1', 'Starting g2', 'Yielded 42',
            'Finishing g2', 'Finishing g1'])
    ...
    def test_raising_exception_in_initial_next_call(self):
        ...
        self.assertEqual(trace, ['Starting g1', 'Starting g2',
            'Finishing g2', 'Finishing g1'])
    ...
    def test_delegation_of_next_call_to_subgenerator(self):
        ...
        for x in g1():
            trace.append('Yielded %s' % (x,))
        self.assertEqual(trace, ['Starting g1', 'Yielded g1 ham',
            'Starting g2', 'Yielded g2 spam', 'Yielded g2 more spam',
            'Finishing g2', 'Yielded g1 eggs', 'Finishing g1'])
    ...
    def test_raising_exception_in_delegated_next_call(self):
        ...
        try:
            ...
            self.fail('subgenerator failed to raise ValueError')
        self.assertEqual(trace, ['Starting g1', 'Yielded g1 ham',
            'Starting g2', 'Yielded g2 spam', 'Finishing g2', 'Finishing g1'])
    ...
    def test_delegation_of_send(self):
        ...
        try:
            ...
            pass
        self.assertEqual(trace, ['Starting g1', 'g1 received 1',
            'Starting g2', 'Yielded g2 spam', 'g2 received 2',
            'Yielded g2 more spam', 'g2 received 3', 'Finishing g2',
            'Yielded g1 eggs', 'g1 received 4', 'Finishing g1'])
    ...
    def test_value_attribute_of_StopIteration_exception(self):
        ...
        e.value = 'eggs'
        pex(e)
        self.assertEqual(trace, ['StopIteration: ', 'value = None',
            'StopIteration: spam', 'value = spam', 'StopIteration: spam',
            'value = eggs'])
    ...
    def test_generator_return_value(self):
        ...
        self.assertEqual(trace, ['Starting g1', 'Yielded g1 ham',
            'Starting g2', 'Yielded g2 spam', 'Yielded g2 more spam',
            'Finishing g2', 'g2 returned None', 'Starting g2',
            'Yielded g2 spam', 'Yielded g2 more spam', 'Finishing g2',
            'g2 returned 1', 'Starting g2', 'Yielded g2 spam',
            'Yielded g2 more spam', 'Finishing g2', 'g2 returned (2,)',
            'Starting g2', 'Yielded g2 spam', 'Yielded g2 more spam',
            'Finishing g2', 'g2 returned StopIteration(3,)',
            'Yielded g1 eggs', 'Finishing g1'])
    ...
    def test_delegating_throw_to_non_generator(self):
        ...
        try:
            ...
            self.fail('subgenerator failed to raise ValueError')
        self.assertEqual(trace, ['Starting g', 'Yielded 0', 'Yielded 1',
            'Yielded 2', 'Yielded 3', 'Yielded 4', 'Finishing g'])
    ...
    def test_attempted_yield_from_loop(self):
        ...
        self.assertEqual(trace, ['g1: starting', 'Yielded: y1',
            'g1: about to yield from g2', 'g2: starting', 'Yielded: y2',
    ...
    def test_returning_value_from_delegated_throw(self):
        ...
        for x in g:
            trace.append('Yielded %s' % (x,))
        self.assertEqual(trace, ['Starting g1', 'Yielded g1 ham',
            'Starting g2', 'Yielded g2 spam', 'Caught LunchError in g2',
            'Yielded g2 yet more spam', 'Yielded g1 eggs', 'Finishing g1'])
    ...
    def test_next_and_return_with_value(self):
        ...
        f((2,))
        f(StopIteration(3))
        self.assertEqual(trace, ['g starting', 'f resuming g',
            'g returning None', 'f caught StopIteration()', 'g starting',
            'f resuming g', 'g returning 1', 'f caught StopIteration(1,)',
            'g starting', 'f resuming g', 'g returning (2,)',
            'f caught StopIteration((2,),)', 'g starting', 'f resuming g',
    ...
    def test_send_and_return_with_value(self):
        ...
        f((2,))
        f(StopIteration(3))
        self.assertEqual(trace, ['g starting', 'f sending spam to g',
            "g received 'spam'", 'g returning None',
            'f caught StopIteration()', 'g starting', 'f sending spam to g',
            "g received 'spam'", 'g returning 1',
            'f caught StopIteration(1,)', 'g starting',
            'f sending spam to g', "g received 'spam'", 'g returning (2,)',
            'f caught StopIteration((2,),)', 'g starting',
            'f sending spam to g', "g received 'spam'",
            'g returning StopIteration(3,)',
            'f caught StopIteration(StopIteration(3,),)'])
    ...
    def test_catching_exception_from_subgen_and_returning(self):
        ...
        for value in (2, (2,), StopIteration(2)):
            ...
            self.assertEqual(trace, [1, 'inner caught ValueError', 
                'inner returned %r to outer' % (value,), repr(value)])
