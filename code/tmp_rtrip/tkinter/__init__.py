...
class Event:
    ...
    def __repr__(self):
        ...
        if self.state == 0:
            ...
            state = self.state
            mods = ('Shift', 'Lock', 'Control', 'Mod1', 'Mod2', 'Mod3',
        ...
        return '<%s event%s>' % (self.type, ''.join(' %s=%s' % (k, attrs[k]
...
class Variable:
    ...
    def __init__(self, master=None, value=None, name=None):
        ...
        elif not self._tk.getboolean(self._tk.call('info', 'exists', self.
            _name)):
    ...
    def trace_info(self):
        ...
        return [(splitlist(k), v) for k, v in map(splitlist, splitlist(self
            ._tk.call('trace', 'info', 'variable', self._name)))]
    ...
    def trace_vinfo(self):
        ...
        """
        return [self._tk.splitlist(x) for x in self._tk.splitlist(self._tk.
...
class Misc:
    ...
    def tk_strictMotif(self, boolean=None):
        ...
        return self.tk.getboolean(self.tk.call('set', 'tk_strictMotif',
            boolean))
    ...
    def tk_setPalette(self, *args, **kw):
        ...
        self.tk.call(('tk_setPalette',) + _flatten(args) + _flatten(list(kw
            .items())))
    ...
    def winfo_colormapfull(self):
        ...
        return self.tk.getboolean(self.tk.call('winfo', 'colormapfull',
            self._w))
    ...
    def winfo_fpixels(self, number):
        ...
        (e.g. "3c") as float."""
        return self.tk.getdouble(self.tk.call('winfo', 'fpixels', self._w,
            number))
    ...
    def keys(self):
        ...
        return [splitlist(x)[0][1:] for x in splitlist(self.tk.call(self._w,
            'configure'))]
    ...
    def __repr__(self):
        return '<%s.%s object %s>' % (self.__class__.__module__, self.
            __class__.__qualname__, self._w)
    _noarg_ = ['_noarg_']
    ...
    def _grid_configure(self, command, index, cnf, kw):
        ...
        if not options:
            return _splitdict(self.tk, self.tk.call('grid', command, self.
                _w, index), conv=self._gridconvvalue)
    ...
    def grid_location(self, x, y):
        ...
        widget is located."""
        return self._getints(self.tk.call('grid', 'location', self._w, x, y)
            ) or None
...
class Wm:
    ...
    def wm_aspect(self, minNumer=None, minDenom=None, maxNumer=None,
        ...
        return self._getints(self.tk.call('wm', 'aspect', self._w, minNumer,
    ...
    def wm_colormapwindows(self, *wlist):
        ...
        if wlist:
            ...
            return [self._nametowidget(x) for x in self.tk.splitlist(self.
                tk.call(args))]
    ...
    def wm_grid(self, baseWidth=None, baseHeight=None, widthInc=None,
        ...
        return self._getints(self.tk.call('wm', 'grid', self._w, baseWidth,
    ...
    def wm_maxsize(self, width=None, height=None):
        ...
        is given."""
        return self._getints(self.tk.call('wm', 'maxsize', self._w, width,
            height))
    maxsize = wm_maxsize
    ...
    def wm_minsize(self, width=None, height=None):
        ...
        the values are given in grid units. Return the current values if None
        is given."""
        return self._getints(self.tk.call('wm', 'minsize', self._w, width,
            height))
    minsize = wm_minsize
    ...
    def wm_overrideredirect(self, boolean=None):
        ...
        is given."""
        return self._getboolean(self.tk.call('wm', 'overrideredirect', self
            ._w, boolean))
...
class Canvas(Widget, XView, YView):
    ...
    def canvasx(self, screenx, gridspacing=None):
        ...
        return self.tk.getdouble(self.tk.call(self._w, 'canvasx', screenx,
            gridspacing))

    def canvasy(self, screeny, gridspacing=None):
        """Return the canvas y coordinate of pixel position SCREENY rounded
        to nearest multiple of GRIDSPACING units."""
        return self.tk.getdouble(self.tk.call(self._w, 'canvasy', screeny,
            gridspacing))

    def coords(self, *args):
        """Return a list of coordinates for the item given in ARGS."""
        return [self.tk.getdouble(x) for x in self.tk.splitlist(self.tk.
            call((self._w, 'coords') + args))]
    ...
    def _create(self, itemType, args, kw):
        ...
        if isinstance(cnf, (dict, tuple)):
            ...
            cnf = {}
        return self.tk.getint(self.tk.call(self._w, 'create', itemType, *(
...
class Listbox(Widget, XView, YView):
    ...
    def selection_includes(self, index):
        ...
        return self.tk.getboolean(self.tk.call(self._w, 'selection',
            'includes', index))
...
class Text(Widget, XView, YView):
    ...
    def compare(self, index1, op, index2):
        ...
        return self.tk.getboolean(self.tk.call(self._w, 'compare', index1,
            op, index2))
    ...
    def image_create(self, index, cnf={}, **kw):
        ...
        return self.tk.call(self._w, 'image', 'create', index, *self.
            _options(cnf, kw))
    ...
    def peer_create(self, newPathName, cnf={}, **kw):
        ...
        self.tk.call(self._w, 'peer', 'create', newPathName, *self._options
            (cnf, kw))
    ...
    def tag_bind(self, tagName, sequence, func, add=None):
        ...
        called additionally to the other bound function or whether it will
        replace the previous function. See bind for the return value."""
        return self._bind((self._w, 'tag', 'bind', tagName), sequence, func,
            add)
    ...
    def tag_nextrange(self, tagName, index1, index2=None):
        ...
        return self.tk.splitlist(self.tk.call(self._w, 'tag', 'nextrange',
    ...
    def tag_prevrange(self, tagName, index1, index2=None):
        ...
        return self.tk.splitlist(self.tk.call(self._w, 'tag', 'prevrange',
            tagName, index1, index2))
    ...
    def tag_ranges(self, tagName):
        ...
        return self.tk.splitlist(self.tk.call(self._w, 'tag', 'ranges',
            tagName))
...
class PanedWindow(Widget):
    ...
    def paneconfigure(self, tagOrId, cnf=None, **kw):
        ...
        if isinstance(cnf, str) and not kw:
            return self._getconfigure1(self._w, 'paneconfigure', tagOrId, 
                '-' + cnf)
