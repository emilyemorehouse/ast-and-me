...
class Font:
    ...
    def actual(self, option=None, displayof=None):
        ...
        if option:
            ...
            return self._mkdict(self._split(self._call('font', 'actual',
                self.name, *args)))
    ...
    def config(self, **options):
        ...
        if options:
            ...
            return self._mkdict(self._split(self._call('font', 'config',
                self.name)))
    configure = config
    ...
    def metrics(self, *options, **kw):
        ...
        if options:
            ...
            return self._tk.getint(self._call('font', 'metrics', self.name,
                *args))
        else:
