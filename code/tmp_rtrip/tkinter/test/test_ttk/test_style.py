...
class StyleTest(AbstractTkTest, unittest.TestCase):
    ...
    def test_map(self):
        ...
        self.assertEqual(style.map('TButton', 'background'), [('active',
            'background', 'blue')] if self.wantobjects else [(
    ...
    def test_lookup(self):
        ...
        self.assertEqual(style.lookup('TButton', 'background', ['active',
            'background']), 'blue')
    ...
    def test_layout(self):
        ...
        self.assertEqual(style.layout('Treeview'), [('null', {'sticky':
            'nswe'})])
