...
class tixCommand:
    ...
    def tix_resetoptions(self, newScheme, newFontSet, newScmPrio=None):
        ...
        if newScmPrio is not None:
            return self.tk.call('tix', 'resetoptions', newScheme,
...
class Tk(tkinter.Tk, tixCommand):
    ...
    def __init__(self, screenName=None, baseName=None, className='Tix'):
        ...
        if tixlib is not None:
            ...
            self.tk.eval('global tcl_pkgPath; lappend tcl_pkgPath {%s}' %
                tixlib)
...
class Form:
    ...
    def slaves(self):
        return [self._nametowidget(x) for x in self.tk.splitlist(self.tk.
            call('tixForm', 'slaves', self._w))]
...
class TixWidget(tkinter.Widget):
    ...
    def __init__(self, master=None, widgetName=None, static_options=None,
        cnf={}, kw={}):
        if kw:
            cnf = _cnfmerge((cnf, kw))
        else:
            ...
            for i in range(len(plist) - 1):
                ...
                try:
                    ...
                    parent = TixSubWidget(parent, plist[i],
                        destroy_physically=0, check_intermediate=0)
            if plist:
                name = plist[-1]
...
class DisplayStyle:
    ...
    def __init__(self, itemtype, cnf={}, *, master=None, **kw):
        ...
        self.tk = master.tk
        self.stylename = self.tk.call('tixDisplayStyle', itemtype, *self.
            _options(cnf, kw))
    ...
    def config(self, cnf={}, **kw):
        return self._getconfigure(self.stylename, 'configure', *self.
            _options(cnf, kw))
...
class ButtonBox(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixButtonBox', ['orientation',
            'options'], cnf, kw)
...
class DirSelectBox(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixDirSelectBox', ['options'],
            cnf, kw)
...
class ExFileSelectBox(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixExFileSelectBox', ['options'],
            cnf, kw)
        ...
        self.subwidget_list['filelist'] = _dummyScrolledListBox(self,
            'filelist')
...
class DirSelectDialog(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixDirSelectDialog', ['options'],
            cnf, kw)
...
class FileSelectDialog(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixFileSelectDialog', ['options'],
            cnf, kw)
...
class FileEntry(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixFileEntry', ['dialogtype',
            'options'], cnf, kw)
...
class HList(TixWidget, XView, YView):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixHList', ['columns', 'options'],
            cnf, kw)
    ...
    def add_child(self, parent=None, cnf={}, **kw):
        if not parent:
            parent = ''
        return self.tk.call(self._w, 'addchild', parent, *self._options(cnf,
            kw))
    ...
    def header_configure(self, col, cnf={}, **kw):
        ...
        self.tk.call(self._w, 'header', 'configure', col, *self._options(
            cnf, kw))
    ...
    def indicator_create(self, entry, cnf={}, **kw):
        self.tk.call(self._w, 'indicator', 'create', entry, *self._options(
            cnf, kw))

    def indicator_configure(self, entry, cnf={}, **kw):
        if cnf is None:
            return self._getconfigure(self._w, 'indicator', 'configure', entry)
        self.tk.call(self._w, 'indicator', 'configure', entry, *self.
            _options(cnf, kw))
    ...
    def info_bbox(self, entry):
        return self._getints(self.tk.call(self._w, 'info', 'bbox', entry)
            ) or None
    ...
    def item_configure(self, entry, col, cnf={}, **kw):
        ...
        self.tk.call(self._w, 'item', 'configure', entry, col, *self.
            _options(cnf, kw))

    def item_create(self, entry, col, cnf={}, **kw):
        self.tk.call(self._w, 'item', 'create', entry, col, *self._options(
            cnf, kw))
...
class LabelEntry(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixLabelEntry', ['labelside',
            'options'], cnf, kw)
        self.subwidget_list['label'] = _dummyLabel(self, 'label')
        self.subwidget_list['entry'] = _dummyEntry(self, 'entry')
...
class ListNoteBook(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixListNoteBook', ['options'],
            cnf, kw)
...
class PanedWindow(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixPanedWindow', ['orientation',
            'options'], cnf, kw)
...
class ResizeHandle(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        flags = ['options', 'command', 'cursorfg', 'cursorbg', 'handlesize',
            'hintcolor', 'hintwidth', 'x', 'y']
...
class ScrolledListBox(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixScrolledListBox', ['options'],
            cnf, kw)
...
class ScrolledText(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixScrolledText', ['options'],
            cnf, kw)
...
class ScrolledWindow(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixScrolledWindow', ['options'],
            cnf, kw)
...
class Select(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixSelect', ['allowzero', 'radio',
            'orientation', 'labelside', 'options'], cnf, kw)
        self.subwidget_list['label'] = _dummyLabel(self, 'label')
...
class Shell(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixShell', ['options', 'title'],
            cnf, kw)
...
class DialogShell(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixDialogShell', ['options',
            'title', 'mapped', 'minheight', 'minwidth', 'parent',
            'transient'], cnf, kw)
...
class StdButtonBox(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixStdButtonBox', ['orientation',
            'options'], cnf, kw)
        self.subwidget_list['ok'] = _dummyButton(self, 'ok')
...
class CheckList(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixCheckList', ['options',
            'radio'], cnf, kw)
        self.subwidget_list['hlist'] = _dummyHList(self, 'hlist')
        self.subwidget_list['vsb'] = _dummyScrollbar(self, 'vsb')
        self.subwidget_list['hsb'] = _dummyScrollbar(self, 'hsb')
...
class Grid(TixWidget, XView, YView):
    ...
    def size_column(self, index, **kw):
        ...
        return self.tk.splitlist(self.tk.call(self._w, 'size', 'column',
            index, *self._options({}, kw)))
    ...
    def size_row(self, index, **kw):
        ...
        given row are changed. Options may be one of the follwing:
              ...
              size val
                     ...
                     given number of characters."""
        return self.tk.splitlist(self.tk.call(self, 'size', 'row', index, *
            self._options({}, kw)))
