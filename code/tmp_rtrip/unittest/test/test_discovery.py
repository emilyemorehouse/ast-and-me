...
class TestDiscovery(unittest.TestCase):
    ...
    def test_find_tests(self):
        ...
        path_lists = [['test2.py', 'test1.py', 'not_a_test.py', 'test_dir',
            'test.foo', 'test-not-a-module.py', 'another_dir'], ['test4.py',
            'test3.py']]
    ...
    def test_find_tests_with_package(self):
        ...
        self.assertEqual(suite, [['a_directory module tests'], [
            'test_directory load_tests', 'test_directory module tests'], [
            'test_directory2 module tests']])
        self.assertEqual(Module.paths, ['a_directory', 'test_directory',
            'test_directory2'])
    ...
    def test_find_tests_customize_via_package_pattern(self):
        ...
        vfs = {abspath('/foo'): ['my_package'], abspath('/foo/my_package'):
            ['__init__.py', 'test_module.py']}
        ...
        self.assertEqual(suite, [['my_package load_tests', [], [
    ...
    def test_discover_with_modules_that_fail_to_import(self):
        ...
        self.assertTrue(
            'Failed to import test module: test_this_does_not_exist' in
            error, 'missing error string in %r' % error)
    ...
    def test_discover_with_init_modules_that_fail_to_import(self):
        ...
        self.assertEqual(1, len(loader.errors))
        error = loader.errors[0]
        self.assertTrue('Failed to import test module: my_package' in error,
    ...
    def test_command_line_handling_do_discovery_too_many_arguments(self):
        ...
        with support.captured_stderr() as stderr, self.assertRaises(SystemExit
            ) as cm:
    ...
    def test_detect_module_clash(self):
        ...
        self.assertRaisesRegex(ImportError, '^%s$' % msg, loader.discover,
