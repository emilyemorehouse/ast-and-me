...
class Test_TestResult(unittest.TestCase):
    ...
    def testGetSubTestDescriptionForFalsyValues(self):
        expected = (
            'testGetSubTestDescriptionForFalsyValues (%s.Test_TestResult) [%s]'
            )
        result = unittest.TextTestResult(None, True, 1)
        for arg in [0, None, []]:
...
class Test_OldTestResult(unittest.TestCase):
    ...
    def testOldTestResult(self):
        ...
        for test_name, should_pass in (('testSkip', True), (
            'testExpectedFail', True), ('testUnexpectedSuccess', False)):
            test = Test(test_name)
    ...
    def testOldResultWithRunner(self):
        ...
        class Test(unittest.TestCase):
            ...
            def testFoo(self):
                pass
        runner = unittest.TextTestRunner(resultclass=OldResult, stream=io.
            StringIO())
...
class TestOutputBuffering(unittest.TestCase):
    ...
    def testBufferOutputAddErrorOrFailure(self):
        unittest.result.traceback = MockTraceback
        self.addCleanup(restore_traceback)
        for message_attr, add_attr, include_error in [('errors', 'addError',
            True), ('failures', 'addFailure', False), ('errors', 'addError',
            True), ('failures', 'addFailure', False)]:
            ...
            expectedFullMessage = 'A traceback%s%s' % (expectedOutMessage,
                expectedErrMessage)
