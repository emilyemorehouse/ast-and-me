...
class Test_TestSkipping(unittest.TestCase):
    ...
    def test_skipping_decorators(self):
        op_table = (unittest.skipUnless, False, True), (unittest.skipIf,
            True, False)
        for deco, do_skip, dont_skip in op_table:
            ...
            expected = ['startTest', 'addSkip', 'stopTest', 'startTest',
                'addSuccess', 'stopTest']
    ...
    def test_expected_failure(self):
        ...
        test = Foo('test_die')
        test.run(result)
        self.assertEqual(events, ['startTest', 'addExpectedFailure',
            'stopTest'])
    ...
    def test_unexpected_success(self):
        ...
        test = Foo('test_die')
        test.run(result)
        self.assertEqual(events, ['startTest', 'addUnexpectedSuccess',
            'stopTest'])
    ...
    def test_unexpected_success_subtests(self):
        ...
        test.run(result)
        self.assertEqual(events, ['startTest', 'addSubTestSuccess',
            'addSubTestSuccess', 'addUnexpectedSuccess', 'stopTest'])
        self.assertFalse(result.failures)
        self.assertEqual(result.unexpectedSuccesses, [test])
        self.assertFalse(result.wasSuccessful())
