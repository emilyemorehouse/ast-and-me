...
class AnyTest(unittest.TestCase):
    ...
    def test_any_mock_calls_comparison_order(self):
        ...
        for d in (datetime.now(), Foo()):
            ...
            expected = [call(ANY, foo=ANY, bar=ANY), call.method(ANY, zinga
                =ANY, alpha=ANY), call(), call().method(a1=ANY, z99=ANY)]
...
class CallTest(unittest.TestCase):
    ...
    def test_call(self):
        ...
        self.assertEqual(call('foo', 'bar', one=3, two=4), ('', ('foo',
            'bar'), {'one': 3, 'two': 4}))
        mock = Mock()
        mock(1, 2, 3)
        mock(a=3, b=6)
    ...
    def test_attribute_call(self):
        ...
        self.assertEqual(call.bar.baz(fish='eggs'), ('bar.baz', (), {'fish':
            'eggs'}))
        mock = Mock()
        mock.foo(1, 2, 3)
        mock.bar.baz(a=3, b=6)
        self.assertEqual(mock.method_calls, [call.foo(1, 2, 3), call.bar.
            baz(a=3, b=6)])
...
class SpecSignatureTest(unittest.TestCase):
    ...
    def test_method_calls(self):
        ...
        mock.attr.two()
        mock.attr.three(3)
        expected.extend([call.attr.one(1, 2), call.attr.two(), call.attr.
            three(3)])
        self.assertEqual(mock.method_calls, expected)
