...
class MockTest(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        for mock, name in mocks:
            ...
            self.assertIn('%s()()' % name, repr(mock()()))
            self.assertIn('%s()().foo.bar.baz().bing' % name, repr(mock()()
                .foo.bar.baz().bing))
    ...
    def test_call(self):
        ...
        self.assertEqual(mock.call_args, ((sentinel.Arg,), {'key': sentinel
            .KeyArg}), 'call_args not set')
        self.assertEqual(mock.call_args_list, [((sentinel.Arg,), {}), ((
    ...
    def test_call_args_comparison(self):
        ...
        self.assertEqual(mock.call_args_list, [(), ((sentinel.Arg,),), ({
            'kw': sentinel.Kwarg},), ((sentinel.Arg,), {'kw': sentinel.Kwarg})]
            )
        self.assertEqual(mock.call_args, ((sentinel.Arg,), {'kw': sentinel.
            Kwarg}))
    ...
    def test_assert_called_with_method_spec(self):
        ...
        def _check(mock):
            ...
            mock.assert_called_with(1, 2, 3)
            mock.assert_called_with(a=1, b=2, c=3)
            self.assertRaises(AssertionError, mock.assert_called_with, 1, b
                =3, c=2)
    ...
    def test_from_spec(self):
        ...
        def test_attributes(mock):
            ...
            mock.__something__
            self.assertRaisesRegex(AttributeError,
                "Mock object has no attribute 'z'", getattr, mock, 'z')
            self.assertRaisesRegex(AttributeError,
                "Mock object has no attribute '__foobar__'", getattr, mock,
                '__foobar__')
    ...
    def test_assert_called_with_message(self):
        mock = Mock()
        self.assertRaisesRegex(AssertionError, 'Not called', mock.
            assert_called_with)

    def test_assert_called_once_with_message(self):
        mock = Mock(name='geoffrey')
        self.assertRaisesRegex(AssertionError,
            "Expected 'geoffrey' to be called once\\.", mock.
    ...
    def test_assert_called_with_failure_message(self):
        ...
        self.assertRaisesWithMsg(AssertionError, message % (expected,),
            mock.assert_called_with, 1, '2', 3, bar='foo')
        mock.foo(1, '2', 3, foo='foo')
        asserters = [mock.foo.assert_called_with, mock.foo.
            assert_called_once_with]
    ...
    def test_side_effect_iterator(self):
        ...
        self.assertEqual([mock(), mock(), mock(), mock()], ['this', 'is',
            'an', 'iter'])
        self.assertRaises(StopIteration, mock)
            ...
            for kwargs in (dict(), dict(spec_set=True)):
                ...
                for One, Two in [(_One, _Two), (['one'], ['two'])]:
                    for kwargs in (dict(), dict(spec_set=True)):
                        ...
                        self.assertRaises(AttributeError, getattr, mock,
                            'three')
                        if 'spec_set' in kwargs:
                            self.assertRaises(AttributeError, setattr, mock,
                                'three', None)
