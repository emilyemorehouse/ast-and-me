...
def request_uri(environ, include_query=True):
    ...
    from urllib.parse import quote
    path_info = quote(environ.get('PATH_INFO', ''), safe='/;=,', encoding=
        'latin1')
...
_hoppish = {'connection': 1, 'keep-alive': 1, 'proxy-authenticate': 1,
    'proxy-authorization': 1, 'te': 1, 'trailers': 1, 'transfer-encoding': 
    1, 'upgrade': 1}.__contains__
